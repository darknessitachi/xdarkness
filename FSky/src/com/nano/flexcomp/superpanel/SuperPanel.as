...
*/
package com.nano.flexcomp.superpanel
{
...
import com.nano.flexcomp.superpanel.SuperPanelEvent;
 ...
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.MAXIMIZE
 */
[Event(name="maximize", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel is minimized.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.MINIMIZE
 */
[Event(name="minimize", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel is restored from either a minimized or 
 *  maximized state.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.RESTORE
 */
[Event(name="restore", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]
 ...
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.DRAG_START
 */
[Event(name="dragStart", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched while the panel is being dragged.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.DRAG
 */
[Event(name="drag", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel stops being dragged.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.DRAG_END
 */
[Event(name="dragEnd", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched when the resize handle is pressed.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.RESIZE_START
 */
[Event(name="resizeStart", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]

/**
 *  Dispatched when the mouse is released from the resize handle.
 *
 *  @eventType com.linkage.cmp.flexcomp.superpanel.SuperPanelEvent.RESIZE_END
 */
[Event(name="resizeEnd", type="com.nano.flexcomp.superpanel.SuperPanelEvent")]
