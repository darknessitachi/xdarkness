package com.sinosoft.fsky.component.tree
{
	...
	public class XCheckTreeItemRender extends XTreeItemRenderer
	{
		...
		private var myTree:XCheckTree;

		public function XCheckTreeItemRender()
		{
			super();
			mouseEnabled=true;
		}
		...
		override protected function createChildren():void
		{
			...
			myTree=this.owner as XCheckTree;
		...
		private function checkBoxToggleHandler(event:MouseEvent):void
		{
			if (data)
			{
				...
				myTree=myListData.owner as XCheckTree;
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			if (super.data)
			{
				if (super.myImage != null)
				{
					myCheckBox.x=super.myImage.x + myTree.checkBoxLeftGap;
					myCheckBox.y=(height - myCheckBox.height) / 2;
					super.myImage.x=myCheckBox.x + myCheckBox.width + myTree.checkBoxRightGap;
					super.label.x=super.myImage.x + super.myImage.width + 3;
				}
				else
				{
