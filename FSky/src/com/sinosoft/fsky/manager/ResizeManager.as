package com.sinosoft.fsky.manager
{
	...
	public class ResizeManager
	{
		...
		[Embed(source="assets/images/resize/mouseMove.gif")]
		private static const CURSOR_MOVE:Class;
		[Embed(source="assets/images/resize/verticalSize.gif")]
		private static const VERTICAL_SIZE:Class;
		[Embed(source="assets/images/resize/horizontalSize.gif")]
		private static const HORIZONTAL_SIZE:Class;
		[Embed(source="assets/images/resize/leftObliqueSize.gif")]
		private static const LEFT_OBLIQUE_SIZE:Class;
		[Embed(source="assets/images/resize/rightObliqueSize.gif")]
		...
		public static function enableResize(targetObj:UIComponent, minSize:Number):void
		{
			...
			FlexGlobals.topLevelApplication.parent.addEventListener(MouseEvent.MOUSE_UP, doMouseUp);
			FlexGlobals.topLevelApplication.parent.addEventListener(MouseEvent.MOUSE_MOVE, doResize);
		...
		private static function doResize(event:MouseEvent):void
		{
			...
			if (resizeObj != null)
			{
				...
				var xPlus:Number=FlexGlobals.topLevelApplication.parent.mouseX - point.x;
				var yPlus:Number=FlexGlobals.topLevelApplication.parent.mouseY - point.y;
