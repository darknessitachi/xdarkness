 ...
 public class DBInit extends Page
 {
   public void DBDataInit()
   {
     ...
     QueryBuilder qb = new QueryBuilder("select count(*) from ZCForumGroup where SiteID=? and (SystemName='版主' or SystemName='超级版主' or SystemName='系统管理员' or SystemName='游客')", 
       SiteID);
