 ...
 public class ArticleHistory extends Page
 {
   ...
   public static void historyDataBind(DataGridAction dga) {
     ...
     QueryBuilder qb = new QueryBuilder("select ID,BackupNo,Title,author,publishDate,Addtime, type,topflag,(case modifytime when null then addtime else modifytime end) as modifytime,backuptime,modifyUser from BZCArticle where id=? order by ID desc", 
       articleID);
     dga.bindData(qb);
   }
 ...
 * Qualified Name:     com.zving.cms.document.ArticleHistory
