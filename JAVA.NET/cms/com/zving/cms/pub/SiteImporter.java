 ...
 public class SiteImporter
 {
   ...
   public boolean importSite(String poolName) {
     ...
     this.isNewSite = (("0".equals(this.map.getString("ID"))) || (StringUtil.isEmpty(this.map.getString("ID"))));
   ...
   public void dealOneEntry(byte[] bs, Object obj)
     throws Exception
   {
     if ((bs == null) || (obj == null)) {
       return;
     ...
     throws Exception
   {
     ...
     if (tableName.equalsIgnoreCase("ZCSite")) {
       ...
       SchemaSet set = (SchemaSet)Class.forName("com.zving.schema." + tableName + "Set").newInstance();
   ...
   public void setSiteIDTableMaxNo(String tableName, DataRow dr, boolean newIDFlag)
   {
     ...
     for (int i = 0; i < this.TableRelas.length; ++i)
       if (this.TableRelas[i].TableCode.equals(tableName)) {
         ...
         String id = getIDMapping(type + "." + this.TableRelas[i].RelaField, dr
     ...
     throws Exception
   {
     ...
     SchemaSet set = (SchemaSet)Class.forName("com.zving.schema." + tr.TableCode + "Set").newInstance();
     for (int i = 0; i < dt.getRowCount(); ++i) {
       Schema schema = (Schema)Class.forName("com.zving.schema." + tr.TableCode + "Schema").newInstance();
       DataRow dr = dt.getDataRow(i);
   ...
   public static Mapx getSiteInfo(String file)
     throws Exception
   {
     FileInputStream fin = null;
     try {
   ...
   public byte[] convertCharset(byte[] bs)
 ...
 * Qualified Name:     com.zving.cms.pub.SiteImporter
