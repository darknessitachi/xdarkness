 ...
 public class ZUploaderServlet extends HttpServlet
 {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
   {
     ...
     try {
       ...
       AbsolutePath = (getServletContext().getRealPath(new StringBuffer(String.valueOf(baseDir)).append("/").append(SiteAlias).append("/").append(PathData).toString()) + "/").replaceAll("//", "/");
       ...
       fields.put("tempPath", (getServletContext().getRealPath(new StringBuffer(String.valueOf(baseDir)).append("/").append(SiteAlias).toString()) + "/Temp/").replaceAll("//", "/"));
 ...
 * Qualified Name:     com.zving.cms.resource.uploader.ZUploaderServlet
