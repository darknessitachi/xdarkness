 ...
 public class CatalogSite extends Page
 {
   public static Mapx init(Mapx params)
   {
     ...
     if (StringUtil.isEmpty(site.getIndexTemplate())) {
       map.put("edit", "<a id='editLink' href='javascript:void(0);' onclick=\"openEditor('')\"><img src='../Platform/Images/icon_edit.gif' width='14' height='14' style='display:none'></a>");
     }
     else {
       String s1 = 
   ...
   public static void onRequestBegin(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     if (StringUtil.isEmpty(type)) {
       ...
       if (StringUtil.isNotEmpty(id)) {
         ...
         if (!siteID.equals(CatalogUtil.getSiteID(id))) return;
         try {
 ...
 * Qualified Name:     com.zving.cms.site.CatalogSite
