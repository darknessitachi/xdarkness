     ...
     for (int i = 0; i < src.getRowCount(); ++i) {
       ...
       if (i == 0) {
         if (!period.equals(DateUtil.toString(today))) {
           ...
           pv = (int)(pv + VisitCount.getInstance().get(siteID, "Global", "PV", "0"));
           uv = (int)(uv + VisitCount.getInstance().get(siteID, "Global", "UV", "0"));
           ip = (int)(ip + VisitCount.getInstance().get(siteID, "Global", "IP", "0"));
           returnVisitor = (int)(returnVisitor + VisitCount.getInstance().get(siteID, "Global", "ReturnVisitor", "0"));
