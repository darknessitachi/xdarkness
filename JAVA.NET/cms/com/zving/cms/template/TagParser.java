 ...
 public class TagParser
 {
     ...
     while (m.find(lastEndIndex)) {
       ...
       if (StringUtil.isEmpty(item)) {
         ...
         if ((page != null) && ("true".equalsIgnoreCase(page))) {
           ...
           String jspContent = "<%DataTable dt_" + varIndex + " = TemplateData.getListTable();" + 
         ...
         else if (("article".equalsIgnoreCase(item)) || ("image".equalsIgnoreCase(item)) || 
         ...
         else if ("friendlink".equalsIgnoreCase(item))
         {
           ...
           if ((!this.isPageBlock) && (this.dirLevel == 0) && (!this.isPreview)) {
   ...
   private void parseAD()
   {
     ...
     while (m.find(lastEndIndex)) {
       ...
       String name = (String)map.get("name");
       String type = (String)map.get("type");
       String jspContent = "<%write(TemplateData.getAD(\"" + name + "\",\"" + type + "\"));%>";
       sb.append(jspContent);
     }
     sb.append(this.content.substring(lastEndIndex));
     this.content = sb.toString();
   ...
   private void parseVote() {
     ...
     while (m.find(lastEndIndex)) {
       ...
       if (voteBodyContent.indexOf("cms:list") > 0) {
         ...
         String jspContent = "<%DataRow " + voteVar + " = TemplateData.getVoteData(\"" + name + "\",\"" + 
   ...
   private void parseInclude()
   {
     ...
     while (m.find(lastEndIndex)) {
       ...
       if (StringUtil.isEmpty(fileName)) {
         ...
         String fileLevelName = fileName.substring(0, fileName.lastIndexOf('.')) + "_" + this.dirLevel + 
