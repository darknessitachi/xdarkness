 ...
 public class ImportIPDB
 {
   ...
   {
     String[] pros = { "新疆", "青海", "宁夏", "内蒙", "黑龙江", "吉林", "辽宁", "河北", "天津", "北京", "山东", "安徽", "江苏", 
     ...
     for (int i = 0; i < dt.getRowCount(); ++i) {
       ...
       long ip2 = Long.parseLong(arr2[0]) * 16777216L + Long.parseLong(arr2[1]) * 65536L + Long.parseLong(arr2[2]) * 
         256L + Long.parseLong(arr2[3]) - 1L;
       if (ip1 < 0L) {
         ip1 = 0L;
       }
