 ...
 public class Patch
 {
   ...
   public static void updateTo1_3_1(BlockingTransaction tran) {
     ...
     try
     {
       tran.addWithException(
         new QueryBuilder("update ZCStatItem set Type='District',SubType='PV' where Type='Client' and SubType='District'"));
     } catch (Exception e) {
       e.printStackTrace();
     }
     ...
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000001", "000020004900000001"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000002", "000020004900000002"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000003", "000020004900000003"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000004", "000020004900000004"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000005", "000020004900000005"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000006", "000020004900000006"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002049000007", "000020004900000008"));
 
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000001", "000021006400000001"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000002", "000021006400000002"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000003", "000021006400000003"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000004", "000021006400000004"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000005", "000021006400000005"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000006", "000021006400000006"));
     tran.add(new QueryBuilder("update ZCCatalog set InnerCode=? where InnerCode=?", "002164000007", "000021006400000007"));
 
     tran.add(new QueryBuilder("update ZCArticle set CatalogInnerCode=(select InnerCode from ZCCatalog where ID=ZCArticle.CatalogID)"));
     try
     {
 ...
 * Qualified Name:     com.zving.platform.pub.Patch
