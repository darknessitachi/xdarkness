 ...
 public class BZCAudioSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("Status", 7, 22, 0, 0, false, false), 
     new SchemaColumn("OrderFlag", 7, 23, 0, 0, true, false), 
     new SchemaColumn("Prop1", 1, 24, 50, 0, false, false), 
     new SchemaColumn("Prop2", 1, 25, 50, 0, false, false), 
     new SchemaColumn("Prop3", 1, 26, 50, 0, false, false), 
     new SchemaColumn("Prop4", 1, 27, 50, 0, false, false), 
     new SchemaColumn("AddUser", 1, 28, 50, 0, true, false), 
     new SchemaColumn("AddTime", 0, 29, 0, 0, true, false), 
     new SchemaColumn("ModifyUser", 1, 30, 50, 0, false, false), 
     new SchemaColumn("ModifyTime", 0, 31, 0, 0, false, false), 
     new SchemaColumn("BackupNo", 1, 32, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 33, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 34, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 35, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 22) { if (v == null) this.Status = null; else this.Status = new Long(v.toString()); return; }
     if (i == 23) { if (v == null) this.OrderFlag = null; else this.OrderFlag = new Long(v.toString()); return; }
     if (i == 24) { this.Prop1 = ((String)v); return; }
     if (i == 25) { this.Prop2 = ((String)v); return; }
     if (i == 26) { this.Prop3 = ((String)v); return; }
     if (i == 27) { this.Prop4 = ((String)v); return; }
     if (i == 28) { this.AddUser = ((String)v); return; }
     if (i == 29) { this.AddTime = ((Date)v); return; }
     if (i == 30) { this.ModifyUser = ((String)v); return; }
     if (i == 31) { this.ModifyTime = ((Date)v); return; }
     if (i == 32) { this.BackupNo = ((String)v); return; }
     if (i == 33) { this.BackupOperator = ((String)v); return; }
     if (i == 34) { this.BackupTime = ((Date)v); return; }
     if (i != 35) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 22) return this.Status;
     if (i == 23) return this.OrderFlag;
     if (i == 24) return this.Prop1;
     if (i == 25) return this.Prop2;
     if (i == 26) return this.Prop3;
     if (i == 27) return this.Prop4;
     if (i == 28) return this.AddUser;
     if (i == 29) return this.AddTime;
     if (i == 30) return this.ModifyUser;
     if (i == 31) return this.ModifyTime;
     if (i == 32) return this.BackupNo;
     if (i == 33) return this.BackupOperator;
     if (i == 34) return this.BackupTime;
     if (i == 35) return this.BackupMemo;
     return null;
   }
