 ...
 public class BZCCatalogConfigSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 35, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 36, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 37, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 38, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 35) { this.BackupNo = ((String)v); return; }
     if (i == 36) { this.BackupOperator = ((String)v); return; }
     if (i == 37) { this.BackupTime = ((Date)v); return; }
     if (i != 38) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 35) return this.BackupNo;
     if (i == 36) return this.BackupOperator;
     if (i == 37) return this.BackupTime;
     if (i == 38) return this.BackupMemo;
     return null;
   }
