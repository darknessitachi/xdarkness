 ...
 public class BZCDatabaseSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("Latin1Flag", 1, 10, 2, 0, false, false), 
     new SchemaColumn("Memo", 1, 11, 100, 0, false, false), 
   ...
   public BZCDatabaseSchema()
   {
     ...
     this.UpdateAllSQL = "update BZCDatabase set ID=?,SiteID=?,Name=?,ServerType=?,Address=?,Port=?,UserName=?,Password=?,DBName=?,TestTable=?,Latin1Flag=?,Memo=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 10) { this.Latin1Flag = ((String)v); return; }
   ...
   public Object getV(int i) {
     ...
     if (i == 10) return this.Latin1Flag;
