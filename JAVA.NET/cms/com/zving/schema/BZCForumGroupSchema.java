 ...
 public class BZCForumGroupSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 43, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 44, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 45, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 46, 50, 0, false, false) };
   ...
   public BZCForumGroupSchema()
   {
     ...
     this.HasSetFlag = new boolean[47];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 42) { if (v == null) this.OrderFlag = null; else this.OrderFlag = new Long(v.toString()); return; }
     if (i == 43) { this.BackupNo = ((String)v); return; }
     if (i == 44) { this.BackupOperator = ((String)v); return; }
     if (i == 45) { this.BackupTime = ((Date)v); return; }
     if (i != 46) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 43) return this.BackupNo;
     if (i == 44) return this.BackupOperator;
     if (i == 45) return this.BackupTime;
     if (i == 46) return this.BackupMemo;
     return null;
   }
