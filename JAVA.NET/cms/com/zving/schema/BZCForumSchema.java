 ...
 public class BZCForumSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("UnLockID", 1, 12, 300, 0, false, false), 
     new SchemaColumn("AllowTheme", 1, 13, 2, 0, false, false), 
     new SchemaColumn("EditPost", 1, 14, 2, 0, false, false), 
     new SchemaColumn("ReplyPost", 1, 15, 2, 0, false, false), 
     new SchemaColumn("Recycle", 1, 16, 2, 0, false, false), 
     new SchemaColumn("AllowHTML", 1, 17, 2, 0, false, false), 
     new SchemaColumn("AllowFace", 1, 18, 2, 0, false, false), 
     new SchemaColumn("AnonyPost", 1, 19, 2, 0, false, false), 
     new SchemaColumn("URL", 1, 20, 200, 0, false, false), 
     new SchemaColumn("Image", 1, 21, 200, 0, false, false), 
     new SchemaColumn("Password", 1, 22, 100, 0, false, false), 
     new SchemaColumn("UnPasswordID", 1, 23, 300, 0, false, false), 
     new SchemaColumn("Word", 1, 24, 200, 0, false, false), 
     new SchemaColumn("PostCount", 8, 25, 0, 0, true, false), 
     new SchemaColumn("ForumAdmin", 1, 26, 100, 0, false, false), 
     new SchemaColumn("TodayPostCount", 8, 27, 0, 0, false, false), 
     new SchemaColumn("LastThemeID", 7, 28, 0, 0, false, false), 
     new SchemaColumn("LastPost", 1, 29, 100, 0, false, false), 
     new SchemaColumn("LastPoster", 1, 30, 100, 0, false, false), 
     new SchemaColumn("OrderFlag", 7, 31, 0, 0, true, false), 
     new SchemaColumn("prop1", 1, 32, 50, 0, false, false), 
     new SchemaColumn("prop2", 1, 33, 50, 0, false, false), 
     new SchemaColumn("prop3", 1, 34, 50, 0, false, false), 
     new SchemaColumn("prop4", 1, 35, 50, 0, false, false), 
     new SchemaColumn("AddUser", 1, 36, 100, 0, true, false), 
     new SchemaColumn("AddTime", 0, 37, 0, 0, true, false), 
     new SchemaColumn("ModifyUser", 1, 38, 100, 0, false, false), 
     new SchemaColumn("ModifyTime", 0, 39, 0, 0, false, false), 
     new SchemaColumn("BackupNo", 1, 40, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 41, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 42, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 43, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 12) { this.UnLockID = ((String)v); return; }
     if (i == 13) { this.AllowTheme = ((String)v); return; }
     if (i == 14) { this.EditPost = ((String)v); return; }
     if (i == 15) { this.ReplyPost = ((String)v); return; }
     if (i == 16) { this.Recycle = ((String)v); return; }
     if (i == 17) { this.AllowHTML = ((String)v); return; }
     if (i == 18) { this.AllowFace = ((String)v); return; }
     if (i == 19) { this.AnonyPost = ((String)v); return; }
     if (i == 20) { this.URL = ((String)v); return; }
     if (i == 21) { this.Image = ((String)v); return; }
     if (i == 22) { this.Password = ((String)v); return; }
     if (i == 23) { this.UnPasswordID = ((String)v); return; }
     if (i == 24) { this.Word = ((String)v); return; }
     if (i == 25) { if (v == null) this.PostCount = null; else this.PostCount = new Integer(v.toString()); return; }
     if (i == 26) { this.ForumAdmin = ((String)v); return; }
     if (i == 27) { if (v == null) this.TodayPostCount = null; else this.TodayPostCount = new Integer(v.toString()); return; }
     if (i == 28) { if (v == null) this.LastThemeID = null; else this.LastThemeID = new Long(v.toString()); return; }
     if (i == 29) { this.LastPost = ((String)v); return; }
     if (i == 30) { this.LastPoster = ((String)v); return; }
     if (i == 31) { if (v == null) this.OrderFlag = null; else this.OrderFlag = new Long(v.toString()); return; }
     if (i == 32) { this.prop1 = ((String)v); return; }
     if (i == 33) { this.prop2 = ((String)v); return; }
     if (i == 34) { this.prop3 = ((String)v); return; }
     if (i == 35) { this.prop4 = ((String)v); return; }
     if (i == 36) { this.AddUser = ((String)v); return; }
     if (i == 37) { this.AddTime = ((Date)v); return; }
     if (i == 38) { this.ModifyUser = ((String)v); return; }
     if (i == 39) { this.ModifyTime = ((Date)v); return; }
     if (i == 40) { this.BackupNo = ((String)v); return; }
     if (i == 41) { this.BackupOperator = ((String)v); return; }
     if (i == 42) { this.BackupTime = ((Date)v); return; }
     if (i != 43) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 12) return this.UnLockID;
     if (i == 13) return this.AllowTheme;
     if (i == 14) return this.EditPost;
     if (i == 15) return this.ReplyPost;
     if (i == 16) return this.Recycle;
     if (i == 17) return this.AllowHTML;
     if (i == 18) return this.AllowFace;
     if (i == 19) return this.AnonyPost;
     if (i == 20) return this.URL;
     if (i == 21) return this.Image;
     if (i == 22) return this.Password;
     if (i == 23) return this.UnPasswordID;
     if (i == 24) return this.Word;
     if (i == 25) return this.PostCount;
     if (i == 26) return this.ForumAdmin;
     if (i == 27) return this.TodayPostCount;
     if (i == 28) return this.LastThemeID;
     if (i == 29) return this.LastPost;
     if (i == 30) return this.LastPoster;
     if (i == 31) return this.OrderFlag;
     if (i == 32) return this.prop1;
     if (i == 33) return this.prop2;
     if (i == 34) return this.prop3;
     if (i == 35) return this.prop4;
     if (i == 36) return this.AddUser;
     if (i == 37) return this.AddTime;
     if (i == 38) return this.ModifyUser;
     if (i == 39) return this.ModifyTime;
     if (i == 40) return this.BackupNo;
     if (i == 41) return this.BackupOperator;
     if (i == 42) return this.BackupTime;
     if (i == 43) return this.BackupMemo;
     return null;
   }
