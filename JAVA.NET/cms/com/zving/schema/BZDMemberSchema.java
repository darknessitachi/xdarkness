 ...
 public class BZDMemberSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 39, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 40, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 41, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 42, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 38) { this.Prop20 = ((String)v); return; }
     if (i == 39) { this.BackupNo = ((String)v); return; }
     if (i == 40) { this.BackupOperator = ((String)v); return; }
     if (i == 41) { this.BackupTime = ((Date)v); return; }
     if (i != 42) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 39) return this.BackupNo;
     if (i == 40) return this.BackupOperator;
     if (i == 41) return this.BackupTime;
     if (i == 42) return this.BackupMemo;
     return null;
   }
