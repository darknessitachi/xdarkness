 ...
 public class BZSBrandSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 34, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 35, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 36, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 37, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 33) { this.ModifyTime = ((Date)v); return; }
     if (i == 34) { this.BackupNo = ((String)v); return; }
     if (i == 35) { this.BackupOperator = ((String)v); return; }
     if (i == 36) { this.BackupTime = ((Date)v); return; }
     if (i != 37) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 34) return this.BackupNo;
     if (i == 35) return this.BackupOperator;
     if (i == 36) return this.BackupTime;
     if (i == 37) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZSBrandSchema
