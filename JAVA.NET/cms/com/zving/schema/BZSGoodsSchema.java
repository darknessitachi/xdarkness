 ...
 public class BZSGoodsSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 54, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 55, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 56, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 57, 50, 0, false, false) };
   ...
   public BZSGoodsSchema()
   {
     ...
     this.HasSetFlag = new boolean[58];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 53) { this.ModifyTime = ((Date)v); return; }
     if (i == 54) { this.BackupNo = ((String)v); return; }
     if (i == 55) { this.BackupOperator = ((String)v); return; }
     if (i == 56) { this.BackupTime = ((Date)v); return; }
     if (i != 57) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 54) return this.BackupNo;
     if (i == 55) return this.BackupOperator;
     if (i == 56) return this.BackupTime;
     if (i == 57) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZSGoodsSchema
