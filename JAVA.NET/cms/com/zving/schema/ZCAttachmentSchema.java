 ...
 public class ZCAttachmentSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("Status", 7, 19, 0, 0, false, false), 
     new SchemaColumn("OrderFlag", 7, 20, 0, 0, true, false), 
     new SchemaColumn("ImagePath", 1, 21, 100, 0, false, false), 
     new SchemaColumn("Prop1", 1, 22, 50, 0, false, false), 
     new SchemaColumn("Prop2", 1, 23, 50, 0, false, false), 
     new SchemaColumn("Prop3", 1, 24, 50, 0, false, false), 
     new SchemaColumn("Prop4", 1, 25, 50, 0, false, false), 
     new SchemaColumn("AddUser", 1, 26, 50, 0, true, false), 
     new SchemaColumn("AddTime", 0, 27, 0, 0, true, false), 
     new SchemaColumn("ModifyUser", 1, 28, 50, 0, false, false), 
     new SchemaColumn("ModifyTime", 0, 29, 0, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 19) { if (v == null) this.Status = null; else this.Status = new Long(v.toString()); return; }
     if (i == 20) { if (v == null) this.OrderFlag = null; else this.OrderFlag = new Long(v.toString()); return; }
     if (i == 21) { this.ImagePath = ((String)v); return; }
     if (i == 22) { this.Prop1 = ((String)v); return; }
     if (i == 23) { this.Prop2 = ((String)v); return; }
     if (i == 24) { this.Prop3 = ((String)v); return; }
     if (i == 25) { this.Prop4 = ((String)v); return; }
     if (i == 26) { this.AddUser = ((String)v); return; }
     if (i == 27) { this.AddTime = ((Date)v); return; }
     if (i == 28) { this.ModifyUser = ((String)v); return; }
     if (i != 29) return; this.ModifyTime = ((Date)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 19) return this.Status;
     if (i == 20) return this.OrderFlag;
     if (i == 21) return this.ImagePath;
     if (i == 22) return this.Prop1;
     if (i == 23) return this.Prop2;
     if (i == 24) return this.Prop3;
     if (i == 25) return this.Prop4;
     if (i == 26) return this.AddUser;
     if (i == 27) return this.AddTime;
     if (i == 28) return this.ModifyUser;
     if (i == 29) return this.ModifyTime;
     return null;
   }
