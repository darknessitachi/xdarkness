 ...
 public class ZCCatalogSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("ListPage", 7, 26, 0, 0, false, false), 
     new SchemaColumn("PublishFlag", 1, 27, 2, 0, true, false), 
     new SchemaColumn("SingleFlag", 1, 28, 2, 0, false, false), 
     new SchemaColumn("HitCount", 7, 29, 0, 0, false, false), 
     new SchemaColumn("Meta_Keywords", 1, 30, 200, 0, false, false), 
     new SchemaColumn("Meta_Description", 1, 31, 200, 0, false, false), 
     new SchemaColumn("OrderColumn", 1, 32, 20, 0, false, false), 
     new SchemaColumn("Integral", 7, 33, 0, 0, false, false), 
     new SchemaColumn("KeywordFlag", 1, 34, 2, 0, false, false), 
     new SchemaColumn("KeywordSetting", 1, 35, 50, 0, false, false), 
     new SchemaColumn("AllowContribute", 1, 36, 2, 0, false, false), 
     new SchemaColumn("ClusterSourceID", 1, 37, 50, 0, false, false), 
     new SchemaColumn("Prop1", 1, 38, 50, 0, false, false), 
     new SchemaColumn("Prop2", 1, 39, 50, 0, false, false), 
     new SchemaColumn("Prop3", 1, 40, 50, 0, false, false), 
     new SchemaColumn("Prop4", 1, 41, 50, 0, false, false), 
   ...
   public ZCCatalogSchema()
   {
     ...
     this.HasSetFlag = new boolean[46];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 26) { if (v == null) this.ListPage = null; else this.ListPage = new Long(v.toString()); return; }
     if (i == 27) { this.PublishFlag = ((String)v); return; }
     if (i == 28) { this.SingleFlag = ((String)v); return; }
     if (i == 29) { if (v == null) this.HitCount = null; else this.HitCount = new Long(v.toString()); return; }
     if (i == 30) { this.Meta_Keywords = ((String)v); return; }
     if (i == 31) { this.Meta_Description = ((String)v); return; }
     if (i == 32) { this.OrderColumn = ((String)v); return; }
     if (i == 33) { if (v == null) this.Integral = null; else this.Integral = new Long(v.toString()); return; }
     if (i == 34) { this.KeywordFlag = ((String)v); return; }
     if (i == 35) { this.KeywordSetting = ((String)v); return; }
     if (i == 36) { this.AllowContribute = ((String)v); return; }
     if (i == 37) { this.ClusterSourceID = ((String)v); return; }
     if (i == 38) { this.Prop1 = ((String)v); return; }
     if (i == 39) { this.Prop2 = ((String)v); return; }
     if (i == 40) { this.Prop3 = ((String)v); return; }
     if (i == 41) { this.Prop4 = ((String)v); return; }
     if (i == 42) { this.AddUser = ((String)v); return; }
     if (i == 43) { this.AddTime = ((Date)v); return; }
     if (i == 44) { this.ModifyUser = ((String)v); return; }
     if (i != 45) return; this.ModifyTime = ((Date)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 26) return this.ListPage;
     if (i == 27) return this.PublishFlag;
     if (i == 28) return this.SingleFlag;
     if (i == 29) return this.HitCount;
     if (i == 30) return this.Meta_Keywords;
     if (i == 31) return this.Meta_Description;
     if (i == 32) return this.OrderColumn;
     if (i == 33) return this.Integral;
     if (i == 34) return this.KeywordFlag;
     if (i == 35) return this.KeywordSetting;
     if (i == 36) return this.AllowContribute;
     if (i == 37) return this.ClusterSourceID;
     if (i == 38) return this.Prop1;
     if (i == 39) return this.Prop2;
     if (i == 40) return this.Prop3;
     if (i == 41) return this.Prop4;
