 ...
 public class ZCDatabaseSchema extends Schema
 {
   ...
   public ZCDatabaseSchema()
   {
     ...
     this.UpdateAllSQL = "update ZCDatabase set ID=?,SiteID=?,Name=?,ServerType=?,Address=?,Port=?,UserName=?,Password=?,DBName=?,TestTable=?,Latin1Flag=?,Memo=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
