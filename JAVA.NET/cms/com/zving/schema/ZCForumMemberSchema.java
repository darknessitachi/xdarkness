 ...
 public class ZCForumMemberSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("DefinedID", 7, 4, 0, 0, false, false), 
     new SchemaColumn("NickName", 1, 5, 100, 0, false, false), 
     new SchemaColumn("ThemeCount", 7, 6, 0, 0, false, false), 
     new SchemaColumn("ReplyCount", 7, 7, 0, 0, false, false), 
     new SchemaColumn("HeadImage", 1, 8, 500, 0, false, false), 
     new SchemaColumn("UseSelfImage", 1, 9, 2, 0, false, false), 
     new SchemaColumn("Status", 1, 10, 2, 0, false, false), 
     new SchemaColumn("ForumScore", 7, 11, 0, 0, false, false), 
     new SchemaColumn("ForumSign", 1, 12, 1000, 0, false, false), 
     new SchemaColumn("LastLoginTime", 0, 13, 0, 0, false, false), 
     new SchemaColumn("LastLogoutTime", 0, 14, 0, 0, false, false), 
   ...
   public ZCForumMemberSchema()
   {
     ...
     this.UpdateAllSQL = "update ZCForumMember set UserName=?,SiteID=?,AdminID=?,UserGroupID=?,DefinedID=?,NickName=?,ThemeCount=?,ReplyCount=?,HeadImage=?,UseSelfImage=?,Status=?,ForumScore=?,ForumSign=?,LastLoginTime=?,LastLogoutTime=?,prop1=?,prop2=?,prop3=?,prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where UserName=?";
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 4) { if (v == null) this.DefinedID = null; else this.DefinedID = new Long(v.toString()); return; }
     if (i == 5) { this.NickName = ((String)v); return; }
     if (i == 6) { if (v == null) this.ThemeCount = null; else this.ThemeCount = new Long(v.toString()); return; }
     if (i == 7) { if (v == null) this.ReplyCount = null; else this.ReplyCount = new Long(v.toString()); return; }
     if (i == 8) { this.HeadImage = ((String)v); return; }
     if (i == 9) { this.UseSelfImage = ((String)v); return; }
     if (i == 10) { this.Status = ((String)v); return; }
     if (i == 11) { if (v == null) this.ForumScore = null; else this.ForumScore = new Long(v.toString()); return; }
     if (i == 12) { this.ForumSign = ((String)v); return; }
     if (i == 13) { this.LastLoginTime = ((Date)v); return; }
     if (i == 14) { this.LastLogoutTime = ((Date)v); return; }
   ...
   public Object getV(int i) {
     ...
     if (i == 4) return this.DefinedID;
     if (i == 5) return this.NickName;
     if (i == 6) return this.ThemeCount;
     if (i == 7) return this.ReplyCount;
     if (i == 8) return this.HeadImage;
     if (i == 9) return this.UseSelfImage;
     if (i == 10) return this.Status;
     if (i == 11) return this.ForumScore;
     if (i == 12) return this.ForumSign;
     if (i == 13) return this.LastLoginTime;
     if (i == 14) return this.LastLogoutTime;
   ...
   {
     if (this.DefinedID == null) return 0L;
     return this.DefinedID.longValue();
   }
