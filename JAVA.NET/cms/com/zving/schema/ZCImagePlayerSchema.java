 ...
 public class ZCImagePlayerSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("RelaCatalogInnerCode", 1, 6, 100, 0, false, false), 
     new SchemaColumn("Height", 7, 7, 0, 0, true, false), 
     new SchemaColumn("Width", 7, 8, 0, 0, true, false), 
     new SchemaColumn("DisplayCount", 7, 9, 0, 0, false, false), 
     new SchemaColumn("IsShowText", 1, 10, 2, 0, true, false), 
   ...
   protected static final String _UpdateAllSQL = "update ZCImagePlayer set ID=?,Name=?,Code=?,SiteID=?,DisplayType=?,ImageSource=?,RelaCatalogInnerCode=?,Height=?,Width=?,DisplayCount=?,IsShowText=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
   ...
   public ZCImagePlayerSchema()
   {
     ...
     this.UpdateAllSQL = "update ZCImagePlayer set ID=?,Name=?,Code=?,SiteID=?,DisplayType=?,ImageSource=?,RelaCatalogInnerCode=?,Height=?,Width=?,DisplayCount=?,IsShowText=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 6) { this.RelaCatalogInnerCode = ((String)v); return; }
     if (i == 7) { if (v == null) this.Height = null; else this.Height = new Long(v.toString()); return; }
     if (i == 8) { if (v == null) this.Width = null; else this.Width = new Long(v.toString()); return; }
     if (i == 9) { if (v == null) this.DisplayCount = null; else this.DisplayCount = new Long(v.toString()); return; }
     if (i == 10) { this.IsShowText = ((String)v); return; }
   ...
   public Object getV(int i) {
     ...
     if (i == 6) return this.RelaCatalogInnerCode;
     if (i == 7) return this.Height;
     if (i == 8) return this.Width;
     if (i == 9) return this.DisplayCount;
     if (i == 10) return this.IsShowText;
   ...
   {
     return this.RelaCatalogInnerCode;
   }
