 ...
 public class ZCVoteSubjectSchema extends Schema
 {
   ...
   public ZCVoteSubjectSchema()
   {
     ...
     this.UpdateAllSQL = "update ZCVoteSubject set ID=?,VoteID=?,Type=?,Subject=?,VoteCatalogID=?,OrderFlag=?,Prop1=?,Prop2=? where ID=?";
   ...
   public void setV(int i, Object v) {
     ...
     if (i != 7) return; this.Prop2 = ((String)v); return;
   }
