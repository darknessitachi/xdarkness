 ...
 public class ZCWebGatherSchema extends Schema
 {
   ...
   public ZCWebGatherSchema()
   {
     ...
     this.UpdateAllSQL = "update ZCWebGather set ID=?,SiteID=?,Name=?,Intro=?,Type=?,ConfigXML=?,ProxyFlag=?,ProxyHost=?,ProxyPort=?,ProxyUserName=?,ProxyPassword=?,Status=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
