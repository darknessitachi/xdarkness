 ...
 public class Shop extends Page
 {
   ...
   public Mapx moveChild(ZCCatalogSchema catalog, long TreeLevel, String parentInnerCode)
   {
     ...
     map.put("update zccatalog set TreeLevel=" + TreeLevel + ",innercode='" + innerCode + "',modifyuser='" + 
       User.getUserName() + "',modifytime='" + DateUtil.getCurrentDate() + "' where id=" + catalogID, new Integer(7));
 
     map.put("update zcarticle set CatalogInnerCode='" + innerCode + "' where catalogid=" + catalogID, new Integer(7));
     map.put("update bzcarticle set CatalogInnerCode='" + innerCode + "' where catalogid=" + catalogID, new Integer(7));
 ...
 * Qualified Name:     com.zving.shop.Shop
