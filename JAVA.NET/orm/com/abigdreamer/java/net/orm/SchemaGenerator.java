...
public class SchemaGenerator {
	...
	private void generateOneTable(Element table) {
		...
		isb.append("import com.xdarkness.framework.orm.Schema;\n");
		isb.append("import com.xdarkness.framework.orm.SchemaColumn;\n");
		isb.append("import com.xdarkness.framework.orm.SchemaSet;\n");
		isb.append("import com.xdarkness.framework.orm.data.DataColumn;\n");
		isb.append("import com.xdarkness.framework.sql.QueryBuilder;\n");
	...
	private void generateSet(String tableCode) {
		...
		sb.append("import com.xdarkness.framework.orm.SchemaSet;\n\n");
