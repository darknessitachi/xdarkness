...
public class SSIProcessor {
	...
	public long process(Reader reader, long lastModifiedDate, PrintWriter writer)
			throws IOException {
		SSIMediator ssiMediator = new SSIMediator(this.ssiExternalResolver,
				lastModifiedDate, this.debug);
		...
		try {
			while (index < fileContents.length()) {
				...
				if (!inside) {
					...
					SSICommand ssiCommand = (SSICommand) this.commands
...
/*
 * com.xdarkness.framework.ssi.SSIProcessor JD-Core Version: 0.6.0
 */