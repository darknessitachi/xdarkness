...
public class SSIServletExternalResolver implements SSIExternalResolver {
	...
	private static Mapx timeMap = new Mapx(5000);
			...
			if (nameParts[1].equals("STRING")) {
				...
				if (nameParts.length == 2) {
					...
					if (queryString != null) {
						...
						String requestEncoding = this.req
	...
	protected String getAbsolutePath(String path) throws IOException {
		String pathWithoutContext = SSIServletRequestUtil
				.getRelativePath(this.req);
	...
	protected ServletContextAndPath getServletContextAndPathFromNonVirtualPath(
		...
		ServletContextAndPath csAndP = new ServletContextAndPath(this.context,
				path);
		return csAndP;
	}
	...
	protected ServletContextAndPath getServletContextAndPathFromVirtualPath(
		...
		if ((!virtualPath.startsWith("/")) && (!virtualPath.startsWith("\\"))) {
			return new ServletContextAndPath(this.context,
	...
	public long getFileLastModified(String path, boolean virtual)
		...
		try {
			...
			if ((".html".equals(ext)) || (".shtml".equals(ext))
					|| (".htm".equals(ext))) {
		...
		try {
			...
			if ((".html".equals(ext)) || (".shtml".equals(ext))
				...
				ResponseIncludeWrapper responseIncludeWrapper = new ResponseIncludeWrapper(
						context, this.req, this.res, basos);
			...
			if ((retVal.equals(""))
					&& (!this.req.getMethod().equalsIgnoreCase("HEAD"))) {
...
/*
 * com.xdarkness.framework.ssi.SSIServletExternalResolver JD-Core Version: 0.6.0
 */