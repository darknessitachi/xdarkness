...
public class DataAccessTest {
	...
	public void executeQuery() throws SQLException {
		Assert.assertTrue((Boolean) dataAccess.executeQuery("SELECT ID FROM TEST",
	...
	public void executeOneValue() throws SQLException{
		Assert.assertTrue((Integer)dataAccess.executeOneValue("SELECT * FROM Test WHERE id=?", new ArrayList<Integer>(){
			{
				add(15);
			}
		})==15);
