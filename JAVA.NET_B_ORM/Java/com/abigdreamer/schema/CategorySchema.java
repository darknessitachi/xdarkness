...
public class CategorySchema extends Schema {
	...
	public static final String _TableCode = "Category";

	public static final String _NameSpace = "com.abigdreamer.schema";

	protected static final String _InsertAllSQL = "insert into Category values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update Category set Id=?,adder=?,addtime=?,moder=?,modtime=?,delstatus=?,constname=?,chinaname=?,optionname=?,maxdepth=?,remark=?,diclevel=?,folderid=?,extchar1name=?,extchar2name=?,extchar3name=?,extchar4name=?,extint1name=?,extint2name=?,extint3name=?,extint1categoryid=?,extint2categoryid=?,extint3categoryid=?,refidOrder=?,refidInt=?,leafuse=?,extTablename=?,sortBy=? where Id=?";

	protected static final String _DeleteSQL = "delete from Category  where Id=?";

	protected static final String _FillAllSQL = "select * from Category  where Id=?";
	...
	public CategorySet query() {
		return query(null, -1, -1);
	}

	public CategorySet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public CategorySet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public CategorySet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (CategorySet)querySet(qb , pageSize , pageIndex);
	}
