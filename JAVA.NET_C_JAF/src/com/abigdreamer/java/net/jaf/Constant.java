...
/**
 * @author Darkness 
 * create on 2010-12-2 下午05:19:15
 * 
 * @version 1.0
 * @since JAVA.NET 1.0
 */
...
public class Constant {
	...
	public static String GlobalCharset;
	
	static {
		initGlobalCharset();
	}

	private static void initGlobalCharset() {
		String file = WebConfig.getClassesPath() + "charset.config";
		if (new File(file).exists()) {
			String txt = FileUtil.readText(file);
			Mapx<String, String> map = XString.splitToMapx(txt, "\n", "=");
			Constant.GlobalCharset = "GBK".equalsIgnoreCase(map
					.getString("global")) ? "GBK" : "UTF-8";
		}
	}
}
