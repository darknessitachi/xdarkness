...
public class ExpressionParseTree {
	...
	private abstract class CompareNode extends ExpressionParseTree.OppNode {
		...
		private CompareNode()
     {
       super(null); this.this$0 = null;
     }

		protected int compareBranches() {
			String val1 = ((ExpressionParseTree.StringNode) this.left)
					.getValue();
			String val2 = ((ExpressionParseTree.StringNode) this.right)
					.getValue();
			return val1.compareTo(val2);
		}

		CompareNode(CompareNode arg2) {
			this();
		}
	}
	...
	private final class GreaterThanNode extends ExpressionParseTree.CompareNode {
		...
		private GreaterThanNode()
     {
       super(null); this.this$0 = null;
		...
		GreaterThanNode(GreaterThanNode arg2) {
			this();
		}
	}
	...
	private final class LessThanNode extends ExpressionParseTree.CompareNode {
		...
		private LessThanNode()
     {
       super(null); this.this$0 = null;
		...
		LessThanNode(LessThanNode arg2) {
			this();
		}
	}
	...
	private abstract class Node {
		...
		private Node()
     {
       this.this$0 = null; }		public abstract boolean evaluate();
	...
	private class StringNode extends ExpressionParseTree.Node {
		...
		public String getValue() {
			if (this.resolved == null)
				this.resolved = ExpressionParseTree.this.ssiMediator
						.substituteVariables(this.value.toString());
...
/*
 * com.xdarkness.framework.ssi.ExpressionParseTree JD-Core Version: 0.6.0
 */