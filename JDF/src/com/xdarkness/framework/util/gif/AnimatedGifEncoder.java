...
public class AnimatedGifEncoder {
	...
	protected void analyzePixels() {
		...
		for (int i = 0; i < nPix; i++) {
			int index = nq.map(this.pixels[(k++)] & 0xFF,
					this.pixels[(k++)] & 0xFF, this.pixels[(k++)] & 0xFF);
	...
	protected void getImagePixels() {
		...
		this.pixels = ((DataBufferByte) this.image.getRaster().getDataBuffer())
				.getData();
	}
	...
	protected void writePixels() throws IOException {
		LZWEncoder encoder = new LZWEncoder(this.width, this.height,
...
/*
 * com.xdarkness.framework.utility.gif.AnimatedGifEncoder JD-Core Version: 0.6.0
 */