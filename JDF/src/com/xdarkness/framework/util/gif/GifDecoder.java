...
public class GifDecoder {
	...
	protected void setPixels() {
		int[] dest = ((DataBufferInt) this.image.getRaster().getDataBuffer())
				.getData();
		...
		if (this.lastDispose > 0) {
			...
			if (this.lastImage != null) {
				int[] prev = ((DataBufferInt) this.lastImage.getRaster()
	...
	protected void readImage() {
		...
		if (this.transparency) {
			...
			this.lastTransparencyColor = new Color(save & 0xF, save & 0xF,
					save & 0xF);
		}
...
/*
 * com.xdarkness.framework.utility.gif.GifDecoder JD-Core Version: 0.6.0
 */