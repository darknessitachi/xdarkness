...
/**
 * 表名称：ZWWorkflowDef备份<br>
 * 表代码：BZWWorkflowDef<br>
 * 表备注：<br>
...
public class BZWWorkflowDefSchema extends Schema {
	...
	public static final SchemaColumn[] _Columns = new SchemaColumn[] {
		...
		new SchemaColumn("Definition", DataColumn.CLOB, 2, 0 , 0 , false , false),
	...
	public void setV(int i, Object v) {
		...
		if (i == 2){Definition = (String)v;return;}
