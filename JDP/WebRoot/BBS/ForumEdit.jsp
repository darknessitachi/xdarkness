...
<script type="text/javascript">
	...
	function searchForum() {
		...
		Server.sendRequest("com.xdarkness.bbs.MasterPanel.changeForum",dc,function(response){
	...
	function editInfoSave() {
		...
		Server.sendRequest("com.xdarkness.bbs.MasterPanel.editForumSave",dc,function(response){
...
<input type="hidden" id="SiteID" value="${SiteID}">
  <tr valign="top">
    ...
    <td width="20">&nbsp;</td>
    <td><sky:init method="com.xdarkness.bbs.MasterPanel.forumEditInit">
   ...
   <tr>
    ...
    <td width="200">
    	<sky:select id="ForumID" onChange="searchForum();">
