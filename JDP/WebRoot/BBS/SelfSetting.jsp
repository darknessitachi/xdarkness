...
<%@page import="com.xdarkness.bbs.ForumUtil"%>
<html>
<head>
...
<script type="text/javascript">
	function perInfoSave() {
		...
		Server.sendRequest("com.xdarkness.bbs.ControlPanel.selfSettingSave",dc,function(response){
...
function afterUpload(path){
	...
	dc.add("SiteID",$V("SiteID"));
	Server.sendRequest("com.xdarkness.bbs.ControlPanel.doSave",dc,function(response){
		if(response.Status!=1){
