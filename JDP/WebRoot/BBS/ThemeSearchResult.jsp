...
<div class="wrap">
<sky:init method="com.xdarkness.bbs.ThemeSearch.init">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<sky:datalist id="list1" method="com.xdarkness.bbs.ThemeSearch.dg1DataBind" page="true" size="12">
		<tr>
			<td>[原创]</td>
	...
	<tr><td colspan="4"><sky:pagebar target="list1"></sky:pagebar></td></tr>  
</table>
</form>
</div>
</sky:init>
