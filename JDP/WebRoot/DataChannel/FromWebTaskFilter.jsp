...
<table width="860" align="center" cellpadding="2" cellspacing="0">
	<tr>
		...
		<sky:button onClick="add()"><img src="../Icons/icon404a8.gif" width="20" height="20" />新增过滤块</sky:button> 
		<sky:button id="RemoveButton" onClick="del()"><img src="../Icons/icon404a5.gif" width="20" height="20" />删除过滤块</sky:button></td>
		<td width="65">&nbsp;</td>
		<td align="right">
