	...
	if(parent.Parent.EditFlag){
		...
		for(k in map){
			...
			if(!k.startWith("FilterBlock")&&!k.startWith("RefCode")&&!k.startWith("Script")&&!k.startWith("Template")&&k!="Type"&&k!="Status"){
				...
				if(k=="CatalogID"&&v){
					Server.getOneValue("com.xdarkness.datachannel.FromWeb.getCatalogName",v,function(dc){
...
<table width="820" align="center" cellpadding="2" cellspacing="0">
 ...
 (-1表示不限制)</td>
			...
			<tr id="trCatalog">
				...
				<td><sky:select id="CatalogID" listWidth="300" verify="NotNull" condition="$NV('Type')=='D'" listHeight="300" listURL="Site/CatalogSelectList.jsp"> </sky:select></td>
			</tr>
			<tr id="trCatalog">
				<td height="24" align="right">&nbsp;</td>
				<td>
				<sky:button onClick="addLevel()"><img src="../Icons/icon404a8.gif" width="20" height="20" />增加URL层级</sky:button>
				<sky:button id="RemoveButton" onClick="removeLevel()"><img src="../Icons/icon404a5.gif" width="20" height="20" />减少URL层级</sky:button></td>
			</tr>
		</table>
		</td>
