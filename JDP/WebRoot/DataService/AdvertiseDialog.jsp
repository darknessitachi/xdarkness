...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.xdarkness.cms.dataservice.Advertise.getImgSrc",dc,function(response){
...
<body>
<sky:init method="com.xdarkness.cms.dataservice.Advertise.DialogInit">
...
<form id="adform" method="post" target="formTarget" enctype="multipart/form-data" action="AdvertiseUpload.jsp">
	<table width="100%" border="0" cellpadding="4" cellspacing=""
		...
		<tr>
			...
			<td>
			<sky:select name="AdType" id="AdType" onChange="changeADType();"> ${AdTypeOptions}</sky:select>
        ...
        <tr>
			...
			<td width="921"><input name="StartDate" id="StartDate" value="${StartDate}" type="text" size="14" xtype="Date"/>
	  <input name="STime" id="STime" value="${STime}" type="text" size="10" xtype="Time"/></td>
		</tr>
        <tr>
			<td align="right" valign="top" width="240">下线时间：</td>
			<td width="921"><input name="EndDate" id="EndDate" value="${EndDate}" type="text" size="14" xtype="Date"/> 
	  <input name="ETime" id="ETime" value="${ETime}" type="text" size="10" xtype="Time"/></td>
		</tr>
		<tr>
