			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="add()">
						<img src="../Icons/icon024a2.gif" />新增</sky:button> <sky:button onClick="del()">
						<img src="../Icons/icon024a3.gif" />删除</sky:button> <sky:button
						onClick="back()">
						<img src="../Icons/icon400a8.gif" />返回</sky:button></td>
				</tr>
				<tr>   <td style="padding:0px 5px;">
<sky:datagrid id="dg1"
						method="com.xdarkness.platform.CustomColumnItem.dg1DataBind" size="15">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr xtype="head" class="dataTableHead">
								...
								<td width="5%" xtype="editDialog" function='editDialog'><b>编辑</b></td>
							</tr>
