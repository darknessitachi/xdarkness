...
<sky:init method="com.xdarkness.cms.dataservice.PublishStaff.initInputorColumn">
<html>
<head>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					<td style="padding:4px 8px;">
						...
						<sky:button onClick="statInputorColumn()"> <img src="../Icons/icon031a1.gif" />统计</sky:button>
						<sky:button onClick="statInputorColumnAll()"> <img src="../Icons/icon031a15.gif" />全部统计</sky:button>
						<sky:button onClick="exportInputorColumn()"> <img src="../Icons/icon031a7.gif" />导出EXCEL</sky:button>
				...
				<tr>
					...
					<sky:datagrid id="dg12" method="com.xdarkness.cms.dataservice.PublishStaff.dg12DataBind" size="14">
