	...
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><sky:tree id="tree1"
					...
					method="com.xdarkness.cms.site.Newspaper.docTreeDataBind">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float: left"><sky:button id="article_inserted"
					onClick="config()">
					<img src="../Icons/icon018a2.gif" />配置</sky:button> <sky:button
					id="article_inserted" onClick="add()">
					<img src="../Icons/icon018a2.gif" />新建</sky:button> <sky:button
					id="article_updated" onClick="save()">
					<img src="../Icons/icon018a16.gif" />保存</sky:button> <sky:button
					id="article_deploy" onClick="publish()">
					<img src="../Icons/icon018a4.gif" />发布</sky:button> <sky:button onClick="copy()">
					<img src="../Icons/icon018a8.gif" />复制</sky:button> <sky:button onClick="move()">
					<img src="../Icons/icon018a7.gif" />转移</sky:button> <sky:button
					id="article_deleted" onClick="del()">
					<img src="../Icons/icon018a3.gif" />删除</sky:button></div>
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.document.ArticleList.dg1DataBind" size="15">
					<table width="100%" cellpadding="2" cellspacing="0"
						class="dataTable">
						<tr xtype="head" class="dataTableHead">
							<td width="4%" height="30" xtype="RowNo" drag="true"><img
							...
							<td width="6%" xtype="editDialog" function="edit"><strong>编辑</strong></td>
