...
Application.onParentSiteChange = function(){//_SiteSelector
	if($("_Navigation")){
  	...
  	Cookie.set("Resource.LastAttachLib","0","2100-01-01");
		Server.sendRequest("com.xdarkness.platform.Application.changeSite",dc,function(){
...
Application.logout = function(){
	Dialog.confirm("您确认要退出系统吗？",function(){
	   Server.sendRequest("com.xdarkness.platform.Application.logout");
	});	
}
...
Application.changePassword = function(){
	...
	d.OKEvent = function(){
		...
		Server.sendRequest("com.xdarkness.platform.Application.changePassword",dc,function(response){
