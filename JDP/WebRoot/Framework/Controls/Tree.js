...
Tree.loadData = function(ele,func){
	...
	Server.sendRequest("com.xdarkness.framework.jaf.controls.TreePage.doWork",ele.Params,function(response){
...
Tree.lazyLoad = function(ele,func){
	...
	Server.sendRequest("com.xdarkness.framework.jaf.controls.TreePage.doWork",tree.Params,function(response){
