...
//	Login.ssoLogin(request,response,((UserData)session.getAttribute(com.xdarkness.zas.Constant.UserSessionAttrName)).getUserName());
//}
%>
<html>
<head>
...
function getRequest(){
	...
	Server.sendRequest("com.xdarkness.platform.License.getRequest",dc,function(response){
		Dialog.alert("生成请求成功");
...
function saveLicense(){
	...
	Server.sendRequest("com.xdarkness.platform.License.saveLicense",dc,function(response){		
    ...
    <tr>
      <td align="center" valign="middle"><div style="margin:0 auto; background-color:#fff; padding:1px; border:1px solid #d2dbe5; width:660px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="3">
            <tr>
              <td colspan="2" height="30" align="center" style="background-color:#E6EEF6" ><h4>获取许可证</h4></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
