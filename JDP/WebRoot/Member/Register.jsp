...
function checkUser(){
	...
	Server.sendRequest("com.xdarkness.member.Register.checkUser",dc,function(response){
	...
	if(checkUser()&&checkPassWord()&&checkConfirmPassword()&&checkEmail()&&checkVerifyCode()&&checkUserFlag){
		if($("Agree").checked==true){
			if($V("SiteID")!=""&&$V("SiteID")!="null"){
				...
				Server.sendRequest("com.xdarkness.member.Register.register",dc,function(response){
					if(response.Status!=1){
...
<sky:init method="com.xdarkness.member.Register.init">
