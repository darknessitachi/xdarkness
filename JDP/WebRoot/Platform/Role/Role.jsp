...
function add(param){
	...
	diag.Height = 150;
	diag.Title = "新建角色";
	diag.URL = "Platform/Role/RoleAddDialog.jsp";
...
function addSave(){
	...
	Server.sendRequest("com.xdarkness.platform.page.RolePageTabBasic.add",dc,function(response){
...
function del(param){
	...
	Dialog.confirm("确认删除 <b style='color:#F00'>"+RoleCode+"</b> 角色吗？",function(){
		...
		Server.sendRequest("com.xdarkness.platform.page.RolePageTabBasic.del",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
...
function showEditDialog(param){
	...
	diag.Height = 80;
	diag.Title = "修改角色";
	diag.URL = "Platform/Role/RoleEditDialog.jsp?RoleCode="+param;
	diag.onLoad = function(){
		$DW.$("RoleName").focus();
	};
...
function editSave(){
	...
	Server.sendRequest("com.xdarkness.platform.page.RolePageTabBasic.save",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				$D.close();
...
function attribute(param){
	...
	diag.Height = 130;
	diag.Title = "属性";
	diag.URL = "Platform/Role/RoleAttribute.jsp?RoleCode="+param;
...
<table width="100%" border="0" cellspacing="6" cellpadding="0" style="border-collapse: separate; border-spacing: 6px;">
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
			<tr>
				<td style="padding:6px;" class="blockTd"><sky:tree id="tree1" style="height:430px;width:160px;" method="com.xdarkness.platform.page.RolePage.treeDataBind">
		...
		<td><sky:tab>
			<sky:childtab id="Basic" src="RoleTabBasic.jsp" selected="true" afterClick="onRoleTabClick('Basic')">
				<img src='../../Icons/icon018a1.gif' />
				<b>基本信息</b>
			</sky:childtab>
			<sky:childtab id="Site" src="" afterClick="onRoleTabClick('Site')">
				<img src="../../Icons/icon040a1.gif" />
				<b>站点权限</b>
			</sky:childtab>
			<sky:childtab id="Menu" src="" afterClick="onRoleTabClick('Menu')">
				<img src="../../Icons/icon018a1.gif" />
				<b>菜单权限</b>
			</sky:childtab>
			<sky:childtab id="Article" src="" afterClick="onRoleTabClick('Article')">
