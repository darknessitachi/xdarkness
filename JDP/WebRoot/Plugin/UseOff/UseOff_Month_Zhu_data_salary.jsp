...
<%
DataTable dataTable = new QueryBuilder("select sum(money) as money, substring(createTime,3,5) as theMonth from useoff where moneyType='in' and useFor='工资' and description is null group  by theMonth").executeDataTable();
