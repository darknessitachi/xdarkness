...
function save(){
	DataGrid.save("dg1","com.xdarkness.cms.site.BadWord.dg1Edit",function(){
...
function addSave(){
	...
	Server.sendRequest("com.xdarkness.cms.site.BadWord.add",dc,function(response){
...
Dialog.confirm("您确认要删除吗？",function(){
	...
	dc.add("IDs",arr.join());
	Server.sendRequest("com.xdarkness.cms.site.BadWord.del",dc,function(response){
...
<body>
<sky:init method="com.xdarkness.cms.site.BadWord.init">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="add()">
						<img src="../Icons/icon007a2.gif" />新建</sky:button> <sky:button
						onClick="save()">
						<img src="../Icons/icon007a16.gif" />保存</sky:button> <sky:button
						onClick="del()">
						<img src="../Icons/icon007a3.gif" />删除</sky:button> <sky:button
						onClick="importWord()">
						<img src="../Icons/icon007a8.gif" />导入</sky:button> <sky:button
						onClick="exportWord()">
						<img src="../Icons/icon007a7.gif" />导出</sky:button>
				...
				<tr>
					...
					<sky:datagrid id="dg1"
						method="com.xdarkness.cms.site.BadWord.dg1DataBind" size="13">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr style1="background-color:#FFFFFF"
								...
								<td>${ReplaceWord}</td>
								<td>
								<div xtype=select name="LevelName${ID}" id="Level${ID}"
							...
							<tr xtype="edit" bgcolor="#E1F3FF">
								...
								<div xtype=select name="Level" id="Level" style="width:100px">
