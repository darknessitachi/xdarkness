		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:0 8px 0;"><sky:button onClick="add()">
					<img src="../Icons/icon018a2.gif" />新建文件</sky:button> <sky:button
					onClick="addDir()">
					<img src="../Icons/icon018a2.gif" />新建目录</sky:button> <sky:button
					onClick="editFile()">
					...
					onClick="importFile()">
					<img src="../Icons/icon026a7.gif" />上传</sky:button> <sky:button
					onClick="exportFiles()">
					<img src="../Icons/icon026a13.gif" />全部导出</sky:button> <sky:button
					onClick="deploy()">
					<img src="../Icons/icon018a2.gif" />分发</sky:button></td>
			</tr>
			<tr>
				<td><sky:explorer id="e1" style="height:400px;"
