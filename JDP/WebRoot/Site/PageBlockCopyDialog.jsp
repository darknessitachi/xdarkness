...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<td width="762">
		<sky:select id="copyType" style="width:120px;"
			onchange="changeCopyType"><span value="0"> 指定栏目</span> <span
			value="1"> 所有子栏目</span> <span value="2"> 所有栏目</span> <span value="3">
		所有同级栏目</span></sky:select>
		</td>
	</tr>
	<tr>
		<td align="right">所属分类:</td>
		<td width="762"><sky:select name="CatalogID" id="CatalogID"
			listWidth="200" listHeight="300"
			listURL="Site/CatalogSelectList.jsp?Type=3&CatalogType=<%=CatalogType%>"></sky:select>
		</td>
