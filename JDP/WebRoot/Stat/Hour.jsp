...
Page.onLoad(function(){
	...
	chart = new Chart("Line2D","Chart1",680,250,"com.xdarkness.cms.stat.report.HourReport.getChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.HourReport.dg1DataBind"
					autoFill="false">
