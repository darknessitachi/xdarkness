...
Page.onLoad(function(){
	...
	chart = new Chart("Line2D","Chart1",690,250,"com.xdarkness.cms.stat.report.LoyaltyReport.getOnlineVisitorChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.LoyaltyReport.dgOnlineVisitorDataBind"
					autoFill="false">
