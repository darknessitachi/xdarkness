...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.xdarkness.cms.stat.report.SourceReport.getSearchEngineChartData");
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>访问来源-搜索引擎:</strong> &nbsp;从 <input
					...
					xtype='date'> 至 <input name="text2" type="text"
					id="EndDate" style="width:90px; " verify="Date" xtype='date'>
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.SourceReport.dgSearchEngineDataBind"
