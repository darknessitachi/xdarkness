...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.xdarkness.cms.stat.report.SourceReport.getSourceChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.SourceReport.dgSourceDataBind"
