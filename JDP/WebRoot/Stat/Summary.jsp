...
Page.onLoad(function(){
	...
	var chart = new Chart("Line2D","Chart1",680,250,"com.xdarkness.cms.stat.report.SummaryReport.getChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<sky:init method="com.xdarkness.cms.stat.report.SummaryReport.init">
              从 ${StartDate} 开始统计，总计 ${TotalDays} 天            </sky:init> </strong></td>
			</tr>
			<tr>
				<td
					style="padding-top:2px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.SummaryReport.dg1DataBind"
