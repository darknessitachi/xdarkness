...
import com.xdarkness.bbs.ForumCache;
...
public class ForumScore {
	...
	public void init(long SiteID) {
		...
		ZCForumScoreSchema score = ForumCache.getScoreBySiteID(String
				.valueOf(SiteID));
		if (score != null) {
...
/*
 * com.xdarkness.bbs.admin.ForumScore JD-Core Version: 0.6.0
 */