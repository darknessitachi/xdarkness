...
import com.xdarkness.cmcore.template.TemplateManager;
		...
		while (file.startsWith(".")) {
			if (file.startsWith("./")) {
				...
				if (path.lastIndexOf("/") < 0) {
					this.context.addError("文件包含路径不正确:"
							+ this.attributes.getString("file"));
				}
...
/*
 * com.xdarkness.cmcore.tag.ZIncludeTag JD-Core Version: 0.6.0
 */