...
public class CommonFtp {
	...
	public synchronized void connect(String host, int port, String user,
		...
		try {
			...
			throw new IOException("Connect to " + host + ":" + port
					+ " Error:  " + ex);
		}
	}
	...
	public synchronized boolean upload(String srcFile, String tarFile)
			throws Exception {
		boolean retval = true;
		...
		try {
			...
			retval = false;
			throw new Exception("上传文件失败：" + srcFile + " to " + tarFile
					+ " Failure! " + ex);
		}
		return retval;
	}
	...
	public static void main(String[] args) {
		...
		try {
			ftp.connect("192.168.1.100", 21, "test", "sky10301");
...
/*
 * com.xdarkness.datachannel.CommonFtp JD-Core Version: 0.6.0
 */