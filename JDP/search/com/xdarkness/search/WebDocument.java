 ...
 * 
 * @author Darkness
 * Create on Nov 19, 2010 1:36:57 PM
 * @version 1.0
 */
public class WebDocument {
	...
	public byte[] getContent() {
		if ((this.Content == null) && (this.List != null) && (this.Url != null)) {
	...
	public String getContentText() {
		try {
			...
			//System.out.println("body:"+new String(bs, this.charset));
	...
	public void parseBytes(byte[] bs) {
		Mapx<String, Object> map = FileUtil.bytesToMap(bs);
		this.Url = map.getString("Url");
		this.RefUrl = map.getString("RefUrl");
		this.charset = map.getString("charset");
		this.isTextContent = ((Boolean) map.get("isTextContent"))
				.booleanValue();
		this.lastmodifiedDate = ((Date) map.get("lastmodifiedDate"));
		this.lastDownloadTime = ((Long) map.get("lastDownloadTime"))
				.longValue();
