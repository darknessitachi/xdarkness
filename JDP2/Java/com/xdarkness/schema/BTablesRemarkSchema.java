...
/**
 * 表名称：TablesRemark备份<br>
 * 表代码：BTablesRemark<br>
 * 表备注：<br>
InnoDB free: 38912 kBInnoDB free: 38912 kB<br>
<br>
 * 表主键：tablename, BackupNo<br>
 */
public class BTablesRemarkSchema extends Schema {
	...
	public static final String _TableCode = "BTablesRemark";

	public static final String _NameSpace = "com.xdarkness.schema";

	protected static final String _InsertAllSQL = "insert into BTablesRemark values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update BTablesRemark set tablename=?,addtime=?,moder=?,modtime=?,alias=?,remark=?,primaryEx1=?,primaryEx2=?,ordercol=?,BoolUseCache=?,tabletype=?,categoryid=?,summarytable=?,summarycol=?,indexid=?,tablechanged=?,colchanged=?,tracelog=?,baseTitle=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where tablename=? and BackupNo=?";

	protected static final String _DeleteSQL = "delete from BTablesRemark  where tablename=? and BackupNo=?";

	protected static final String _FillAllSQL = "select * from BTablesRemark  where tablename=? and BackupNo=?";

	public BTablesRemarkSchema(){
	...
	protected Schema newInstance(){
		return new BTablesRemarkSchema();
	}
	...
	public BTablesRemarkSet query() {
		return query(null, -1, -1);
	}

	public BTablesRemarkSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public BTablesRemarkSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public BTablesRemarkSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (BTablesRemarkSet)querySet(qb , pageSize , pageIndex);
	}
