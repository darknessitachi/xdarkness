...
public class BZCVideoSchema extends Schema {
	...
	public static final SchemaColumn[] _Columns = new SchemaColumn[] {
		...
		new SchemaColumn("Count", DataColumn.LONG, 18, 20 , 0 , true , false),
		new SchemaColumn("Width", DataColumn.LONG, 19, 20 , 0 , true , false),
		new SchemaColumn("Height", DataColumn.LONG, 20, 20 , 0 , true , false),
		new SchemaColumn("Duration", DataColumn.LONG, 21, 20 , 0 , true , false),
