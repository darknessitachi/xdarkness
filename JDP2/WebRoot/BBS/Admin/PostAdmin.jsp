...
<body>
<sky:tab>
	<sky:childtab id="MessageReceive" src="PostAudit.jsp" selected="true" onClick="reloadPage('MessageReceive')">
		<img src="../../Icons/icon003a13.gif"/><b>审核帖子</b>
	</sky:childtab>
	<sky:childtab id="Message" src="UserApplyDel.jsp" onClick="reloadPage('Message')">
