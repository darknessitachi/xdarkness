...
<script type="text/javascript">
	function exeAudit() {
		...
		if(ids!=""){
			dc.add("ids",ids);
			Server.sendRequest("com.xdarkness.bbs.admin.PostAudit.exeAudit",dc,function(response){
...
<body>
	...
	<div style="padding:5px;">
		<sky:datalist id="list1" method="com.xdarkness.bbs.admin.PostAudit.getUnauditedPost" page="true" size="12">
		<div class="forumbox">
