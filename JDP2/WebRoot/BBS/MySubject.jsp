...
<body>
<div class="wrap">
<sky:init method="com.xdarkness.oa.commonality.MySubject.init">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<sky:datalist id="list1" method="com.xdarkness.oa.commonality.MySubject.getList" page="true" size="12">
		<tr>
			<td>[原创]</td>
		...
		<tr>
			<td colspan="3"><sky:pagebar target="list1" /></td>
		</tr>
