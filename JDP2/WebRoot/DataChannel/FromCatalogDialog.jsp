...
<sky:init method="com.xdarkness.datachannel.FromCatalog.init">
<form id="form2">
<table width="780" align="center" cellpadding="2" cellspacing="0">
	...
	<tr>
	  ...
	  <td bordercolor="#eeeeee" class="tdgrey2">${SyncArticleModify}</td>
		...
		<td bordercolor="#eeeeee" class="tdgrey2"><sky:select id="AfterInsertStatus">${AfterInsertStatus}</sky:select></td>
	</tr>
	<tr>
	...
	<tr>
	  <td height="35" colspan="4" align="center" class="tdgrey2"><sky:datagrid id="dg1" multiSelect="false" method="com.xdarkness.datachannel.FromCatalog.dialogDataBind" page="false" size="8">
