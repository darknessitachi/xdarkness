...
function checkScript(){
	...
	Server.sendRequest("com.xdarkness.framework.script.CheckScript.check",dc,function(response){
...
<table width="850" cellpadding="2" cellspacing="0" style="-moz-user-select:none;" onselectstart="return false" onselect="document.selection.empty()">
	<tr>
		...
		<sky:button onClick="checkScript()"><img src="../Icons/icon403a12.gif" width="20" height="20" />检查脚本</sky:button>
		</td>
