...
function del(){
	...
	Dialog.confirm("确定要删除选中的会员吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.xdarkness.cms.dataservice.ApplyAdmin.del",dc,function(){
...
<body>
<sky:init method="com.xdarkness.cms.dataservice.ApplyAdmin.initSearch">
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="del()">
					<img src="../Icons/icon021a3.gif"/>删除</sky:button>
				<div style="float: right; white-space: nowrap;">
                  	  <div xtype='select' id="searchGender" style="width:50px;">${Gender}</div>&nbsp;	
	                  <div xtype='select' id="searchEduLevel" style="width:100px;">${EduLevel}</div>&nbsp;
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.dataservice.ApplyAdmin.dg1DataBind" size="15">
