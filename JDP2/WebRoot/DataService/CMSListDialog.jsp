...
<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <sky:tree id="tree1" style="height:410px" method="com.xdarkness.cms.dataservice.OuterDocument.cmsTreeDataBind">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <sky:datagrid id="dg1" method="com.xdarkness.cms.dataservice.OuterDocument.cmsDataBind" size="12">
