...
function setSpell(){
	if($V("Code") == ""){
	  $S("Code",getSpellskyName")));
  }
}
</script>
</head>
<body class="dialogBody">
<sky:init method="com.xdarkness.cms.dataservice.Column.initDialog">
<form id="form2">
<table width="450" height="100" border="0" align="center" cellpadding="4" cellspacing="" bordercolor="#DEDEDC" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <td  >
      <sky:select id="InputType" onChange="changeInputType()">
      ${InputType}
      </sky:select>
      </td>
    </tr>
    ...
    <tr>
     ...
     <tr>
      ...
      <td ><sky:select id="DataType" name="DataType"> ${DataType}</sky:select></td>
    </tr>
