...
function Save(){
	...
	Server.sendRequest("com.xdarkness.platform.CustomColumn.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.xdarkness.platform.CustomColumn.del",dc,function(response){
				if(response.Status==1){
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
          <tr>
            <td valign="middle" class="blockTd"><img src="../Icons/icon002a1.gif" />自定义表单列表</td>
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="add()"><img src="../Icons/icon024a2.gif"/>新建</sky:button>
...
<sky:datagrid id="dg1" method="com.xdarkness.platform.CustomColumn.dg1DataBind" size="15">
