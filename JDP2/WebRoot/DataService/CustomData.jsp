...
function save(){
	...
	Server.sendRequest("com.xdarkness.cms.dataservice.CustomTable.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.xdarkness.cms.dataservice.CustomTable.del",dc,function(response){
				Dialog.alert(response.Message,function(){
					DataGrid.loadData('dg1');
				});
			});
...
function saveForm(){
	...
	Server.sendRequest("com.xdarkness.cms.dataservice.Form.save",dc,function(response){
...
function reInit(){
	var dc = new DataCollection();
	dc.add("ID",$DW.$V("ID"));
	Server.sendRequest("com.xdarkness.cms.dataservice.Form.reInit",dc,function(response){
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            <tr>
              <td valign="middle" class="blockTd"><img src="../Icons/icon005a1.gif" width="20" height="20" /> 自定义数据列表</td>
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="add()"><img src="../Icons/icon005a2.gif" width="20" height="20"/>添加</sky:button>
				<sky:button onClick="edit()"><img src="../Icons/icon005a4.gif" width="20" height="20"/>修改</sky:button>
				<sky:button onClick="del()"><img src="../Icons/icon005a3.gif" width="20" height="20"/>删除</sky:button>
				<sky:button onClick="dataEdit()"><img src="../Icons/icon005a7.gif" width="20" height="20" />数据管理</sky:button>
				<sky:button onClick="editForm()"><img src="../Icons/icon002a1.gif" width="20" height="20" />自定义表单</sky:button>
				<sky:button onClick="conn()"><img src="../Icons/icon006a10.gif" width="20" height="20" />外部连接</sky:button>
			 </td>
            </tr>
            <tr>
              <td style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:0px;"><sky:datagrid id="dg1" method="com.xdarkness.cms.dataservice.CustomTable.dg1DataBind" page="false">
                <table width="100%" cellpadding="2" cellspacing="0" class="dataTable" >
                  <tr xtype="head" class="dataTableHead">
                    <td  width="4%" xtype="rowno">&nbsp;</td>
