...
<body>
<sky:init method="com.xdarkness.cms.dataservice.FullText.init">
<form id="F1">
  <table width="100%" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td width="60%">
	  <sky:tree id="tree1" style="height:320px;width:300px" method="com.xdarkness.cms.dataservice.FullText.treeDataBind" level="2" lazy="true" expand="true">
