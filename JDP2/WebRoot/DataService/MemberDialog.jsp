...
function checkName(){
	...
	Server.sendRequest("com.xdarkness.cms.dataservice.Member.checkName",dc,function(){
...
<sky:init method="com.xdarkness.cms.dataservice.Member.initAddDialog">
	<form id="form2">
	<table width="100%" cellpadding="2" cellspacing="0" align="center">
        ...
        <tr>
			...
			<td height="25">
            <input name="Email" type="text" value="" style="width:150px" class="inputText" id="Email" verify="电子邮件|NotNull&&Email" />
            </td>
		</tr>
		<tr>
			<td height="25" align="right" class="tdgrey1">会员类型：</td>
			<td height="25">
            <sky:select id="Type" name="Type" style="width:150px" listWidth="150"> ${Type}</sky:select>
			</td>
		</tr>
		<tr>
			<td height="25" align="right" class="tdgrey1">会员级别：</td>
			<td height="25">
            <sky:select id="MemberLevel" name="MemberLevel" style="width:150px" listWidth="150"> ${MemberLevel}</sky:select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><sky:select id="Status" name="Status" style="width:150px" listWidth="150"> ${Status}</sky:select></td>
		</tr>
		<tr>
