...
<sky:init method="com.xdarkness.cms.dataservice.Member.initDialog">
	<form id="form2">
	<table width="100%" cellpadding="2" cellspacing="0" align="center">
        ...
        <tr>
			...
			<td height="25">
            <input name="Email" type="text" value="${Email}" style="width:150px" class="inputText" id="Email" verify="电子邮件|NotNull&&Email" />
            </td>
		</tr>
		<tr>
