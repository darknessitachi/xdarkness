	...
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;">
					<sky:tree id="tree1" style="height:380px" method="com.xdarkness.cms.document.ArticleList.treeDataBind" level="2" lazy="true" resizeable="true">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.document.ArticleList.dialogDg1DataBind"
					size="15">
