...
function editSave(){
	...
	Server.sendRequest("com.xdarkness.cms.document.Weekwork.save",dc,function(response){
...
function addSave(){
	...
	Server.sendRequest("com.xdarkness.cms.document.Weekwork.addSave",dc,function(response){
		Dialog.alert(response.Message);
		if(response.Status==1){
				$D.close();
				DataGrid.loadData('dg1');
...
function editNote(ID){
	...
	dc.add("ID",ID);
	Server.sendRequest("com.xdarkness.cms.document.Weekwork.edit",dc,function(response){
		if(response.Status==1){
...
function editNoteSave(ID){
	...
	dc.add("ID",ID);
	dc.add("memo",text);
	Server.sendRequest("com.xdarkness.cms.document.Weekwork.editSave",dc,function(response){
...
function cancle(ID){
	...
	<body>
<sky:init method="com.xdarkness.cms.document.Weekwork.init">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					<td style="padding:0 8px 4px;">
						...
						<img src="../Icons/icon048a16.gif" />新建</sky:button></td>
				...
				<tr>
					...
					<sky:datagrid id="dg1"
						method="com.xdarkness.cms.document.Weekwork.dg1DataBind" size="9">
						<table width="100%" cellpadding="2" cellspacing="0"
							class="dataTable">
							<tr xtype="head" class="dataTableHead ">
								<td width="4%" height="30" xtype="RowNo">序号</td>
