...
<sky:init method="com.xdarkness.platform.MenuGroup.initDialog">
...
<table width="100%" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      菜单项：</strong> </td>
      <td align="center">
			<sky:datagrid id="dg1" method="com.xdarkness.platform.Menu.dg1DataBind" edit="false">
			  <table width="100%" cellpadding="2" cellspacing="0" >
				<tr>
				  <td height="1"></td>
				  <td xtype="tree"  field="id" level="level" sql = "select MenuID from ZDMenuGroupDetail where MenuGroupID = ${MenuGroupID}"></td>
			    </tr>
				<tr>
				  <td width="5" >&nbsp;</td>
