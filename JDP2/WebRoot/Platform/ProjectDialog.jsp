...
<table width="100%" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td><input name="BeginTime" xtype="date" type="text" class="input1" id="BeginTime" size=20 verify="项目开始时间|NotNull"/></td>
    </tr>
    <tr>
      <td align="right" >项目结束时间：</td>
      <td><input name="EndTime" xtype="date" type="text" class="input1" id="EndTime" size=20 verify="项目结束时间|NotNull"/></td>
    </tr>
    <tr>
