...
function init(){
	...
	Server.sendRequest("com.xdarkness.platform.page.RoleTabMenuPage.getCheckedMenu",dc,function(response){
...
function save(){
	...
	Server.sendRequest("com.xdarkness.platform.page.RoleTabMenuPage.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <sky:init method="com.xdarkness.platform.page.RoleTabMenuPage.init">
    <td style="padding:4px 5px;"><sky:button onClick="save()"><img src="../../Icons/icon018a4.gif"/>保存</sky:button>
...
<sky:datagrid id="dg1" method="com.xdarkness.platform.page.RoleTabMenuPage.dg1DataBind">
			  <table width="100%" cellpadding="2" cellspacing="0"  class="dataTable">
				<tr xtype="head" class="dataTableHead">
				  <td  width="6%" xtype="RowNo">序号</td>
				  <td width="94%" xtype="tree"  field="ID" level="treelevel">菜单名称</td>
			    </tr>
				<tr>
				  <td >&nbsp;</td>
