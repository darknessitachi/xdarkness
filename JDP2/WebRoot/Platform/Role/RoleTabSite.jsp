...
function save(){
	...
	Server.sendRequest("com.xdarkness.platform.page.RoleTabSitePage.dg1Edit",dc,function(response){
...
<sky:datagrid id="dg1" method="com.xdarkness.platform.page.RoleTabSitePage.dg1DataBind" size="14">
