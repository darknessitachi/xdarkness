...
function init(){
	...
	Server.sendRequest("com.xdarkness.platform.UserTabMenu.getCheckedMenu",dc,function(response){
...
function save(){
	...
	Server.sendRequest("com.xdarkness.platform.UserTabMenu.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <sky:init method="com.xdarkness.platform.UserTabMenu.init">
...
<sky:datagrid id="dg1" method="com.xdarkness.platform.UserTabMenu.dg1DataBind">
