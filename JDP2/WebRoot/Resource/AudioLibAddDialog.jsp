...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.xdarkness.cms.resource.AudioLib.getPicSrc",dc,function(response){
...
<form id="form2"><sky:init
	method="com.xdarkness.cms.resource.AudioLib.initDialog">
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td colspan="2"><sky:select id="ParentID" listWidth="200"
				listHeight="300" listURL="Resource/AudioLibSelectList.jsp"></sky:select></td>
		</tr>
		<tr>
