...
function save(mess){
	...
	Server.sendRequest("com.xdarkness.cms.resource.ConfigImageLib.save",dc,function(response){
		if(mess){
			...
			<tr>
              ...
              %> <label><input name="WaterMarkType" type="radio"
					...
					<tr id="tr_FontSize" style="<%=TextStyle %>">
						<td align="right">文字大小：</td>
						<td align="left">
						<sky:select id="FontSize" name="FontSize" style="width:60px">
							<%=HtmlUtil.codeToOptions("WaterMark.FontSize", Text.attributeValue("FontSize"))%>
						</sky:select>
						</td>
					</tr>
					<tr id="tr_FontColor" style="<%=TextStyle %>">
						<td align="right">文字颜色：</td>
						<td align="left">
						<sky:select id="FontColor" name="FontColor"
