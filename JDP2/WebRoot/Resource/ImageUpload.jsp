...
<%@page import="com.xdarkness.cms.resource.ConfigImageLib"%>
<%@page import="com.xdarkness.framework.utility.Mapx"%>
<%@page import="com.xdarkness.framework.utility.Filter"%>
<html>
<head>
...
<%
	...
	if(CatalogID!=null&&!"".equals(CatalogID)&&!"null".equals(CatalogID)){
		qb = new QueryBuilder("select id,name,InnerCode from zccatalog where type=4 and id =?",CatalogID);
	}else{
					...
					<tr>
						...
						<table width="100%" cellpadding="2" cellspacing="0">
							<tr>
								...
								<td width="76%"><sky:select id="SelectCatalogID"
									style="width:80px" onChange="setCatalogID()" listWidth="150"
									listHeight="300" listURL="Resource/ImageLibSelectList.jsp"> </sky:select>
                                    <div id="divMsg"></div>
								</td>
							</tr>
							<% 
