...
<table width="100%" cellpadding="2" cellspacing="0">
	<tr>
		...
		<table width="100%" cellpadding="2" cellspacing="0">
			<tr>
				<td width="20%" align="left"><label>所属库:<sky:select
					id="CatalogID" listWidth="200" listHeight="300"
					listURL="Resource/VideoLibSelectList.jsp"> </sky:select></label></td>
				<td width="6%">名称：</td>
	...
	<tr>
		<td style="padding:0px 5px;"><sky:datagrid id="dg1"
			method="com.xdarkness.cms.resource.VideoLib.dg1DataBindBrowse" size="12">
