			...
			<table cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
				  <td height="30" valign="middle" nowrap>起始日期：</td><td>
					<input name=startdate id="startdate" value="<%=startdate%>" xtype="Date" style="width:130px;height:18px"></td>
			 	</tr>
				<tr>
				  <td height="30" valign="middle" nowrap>结束日期：</td><td>
                  <input name=enddate id="enddate" value="<%=enddate%>" xtype="Date" style="width:130px;height:18px"></td>
			  	</tr>
				<tr>
