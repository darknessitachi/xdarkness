...
function save(){
	...
	Server.sendRequest("com.xdarkness.cms.dataservice.Apply.add",dc,function(response){
...
<sky:init method="com.xdarkness.cms.dataservice.Apply.init">
  ...
  <tr>
		...
		<tr>
			...
			<td width="330"><input
				...
				style="width:80px;" value="" xtype="Date"
