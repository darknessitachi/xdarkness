...
<table width="100%" border="0" cellspacing="6" cellpadding="0"
	...
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><sky:tree id="tree1"
					...
					method="com.xdarkness.cms.site.Catalog.treeDataBind" level="3"
					lazy="true">
		...
		<td><sky:tab>
			<sky:childtab id="Basic" onClick="onTabChange('Basic')"
				src="about:blank" selected="true">
				<img src="../Icons/icon002a1.gif" />
				<b>栏目属性</b>
			</sky:childtab>
			<sky:childtab id="Config" onClick="onTabChange('Config')"
				src="about:blank">
				<img src="../Icons/icon023a7.gif" width="20" height="20" />
				<b>栏目设置</b>			</sky:childtab>
