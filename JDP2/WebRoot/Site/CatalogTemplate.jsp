...
function save(){
	...
	Server.sendRequest("com.xdarkness.cms.site.Catalog.saveTemplate",dc,function(response){
...
<sky:init method="com.xdarkness.cms.site.Catalog.init">
	...
	<table width="100%" cellpadding="4" cellspacing="0">
		<tr>
			<td><sky:button onClick="save();">
				<img src="../Icons/icon002a2.gif" width="20" height="20" />保存</sky:button></td>
		</tr>
	</table>
	<form id="form2">
	<table width="100%" border="0" cellpadding="2" cellspacing="0"
		...
		<tr>
			<td>模板沿用:</td>
			<td><sky:select id="Extend" style="width:150px;"> ${Extend} </sky:select>
			</td>
		</tr>
	</table>
	</form>
