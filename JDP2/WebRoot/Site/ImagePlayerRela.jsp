...
function onUploadCompleted(returnID){
	...
	var method="com.xdarkness.cms.site.ImagePlayerRela.relaImage";
	if(type=='edit'){
		dc.add("OldImageID",$V("DoImageID"));
		method="com.xdarkness.cms.site.ImagePlayerRela.editImage";
	}
...
function save(){
	DataGrid.save("dg1","com.xdarkness.cms.site.ImagePlayerRela.dg1Edit",function(){window.parent.location.reload();});
}
...
function del(){
	...
	Dialog.confirm("您确认要删除吗？",function(){
		...
		dc.add("ImagePlayerID",$V("ImagePlayerID"));
		dc.add("IDs",arr.join());
		Server.sendRequest("com.xdarkness.cms.site.ImagePlayerRela.del",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData("dg1");
				}			
...
function afterRowDragEnd(type,targetDr,sourceDr,rowIndex,oldIndex){
	...
	Server.sendRequest("com.xdarkness.cms.site.ImagePlayerRela.sortColumn",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				DataGrid.loadData("dg1");
			}
...
<table width="100%" border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td style="padding:4px 5px;"><sky:button onClick="addImage();"
			id="UploadButton"><img src="../Icons/icon039a2.gif" />添加</sky:button> 
            <sky:button onClick="$('dg1').edit();" id="SaveButton"><img src="../Icons/icon039a4.gif" width="20" height="20" />修改</sky:button> 
			<sky:button onClick="save();"><img src="../Icons/icon039a16.gif" />保存</sky:button> 
            <sky:button onClick="del();" id="DelButton"><img src="../Icons/icon039a3.gif" />删除</sky:button> 
            <sky:button onClick="publishIndex();"><img src="../Icons/icon002a1.gif" />发布</sky:button>
			<div style="float: right; white-space: nowrap;"><b style='color:#F00'>最多可添加6张图片&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></div></td>
	</tr>
	<tr>
		<td style="padding:0px 5px;"><sky:datagrid id="dg1"
			method="com.xdarkness.cms.site.ImagePlayerRela.dg1DataBind" page="false">
			<table width="100%" cellpadding="2" cellspacing="0" class="dataTable"
				afterdrag="afterRowDragEnd">
				<tr xtype="head" class="dataTableHead">
					<td width="6%" xtype="RowNo" drag="true"><img
						src="../Framework/Images/icon_drag.gif" width="16" height="16"></td>
					<td width="6%" xtype="selector" field="ID">&nbsp;</td>
