...
function addSave(){
	...
	Server.sendRequest("com.xdarkness.cms.site.Link.add",dc,function(response){
...
function editSave(){
	...
	Server.sendRequest("com.xdarkness.cms.site.Link.edit",dc,function(response){
...
function save(){
	DataGrid.save("dg2","com.xdarkness.cms.site.Link.save",function(){DataGrid.loadData('dg2');});
}
...
function del(){
	...
	Dialog.confirm("您确认要删除吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.xdarkness.cms.site.Link.del",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg2');
				}
...
function afterRowDragEnd(type,targetDr,sourceDr,rowIndex,oldIndex){
	...
	Server.sendRequest("com.xdarkness.cms.site.Link.sortColumn",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				DataGrid.loadData("dg2");
			}
...
%>
	<table width="100%" border="0" cellspacing="0" cellpadding="6">
		<tr>
			...
			<sky:button onClick="add();"><img src="../Icons/icon028a2.gif" />新建</sky:button> 
			<sky:button onClick="$('dg2').edit();"><img src="../Icons/icon028a16.gif" />修改</sky:button> 
			<sky:button onClick="save();"><img src="../Icons/icon028a16.gif" />保存</sky:button> 
			<sky:button onClick="del();"><img src="../Icons/icon028a3.gif" />删除</sky:button></td>
		</tr>
		<tr>
			<td
				style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
			<sky:datagrid id="dg2" method="com.xdarkness.cms.site.Link.dg1DataBind">
				<table width="100%" cellpadding="2" cellspacing="0"
					...
					<%} else { %>
					<tr xtype="head" class="dataTableHead">
						<td width="8%" xtype="RowNo" drag="true"><img
							src="../Framework/Images/icon_drag.gif" width="16" height="16"></td>
