...
<sky:init method="com.xdarkness.cms.site.CatalogSite.init">
	...
	<table width="100%" cellpadding='0' cellspacing='0'>
		<tr>
			<td><sky:button onClick="addMag();">
				<img src="../Icons/icon002a2.gif" width="20" height="20" />新建期刊</sky:button> <sky:button
				onClick="batchAdd();">
				<img src="../Icons/icon002a9.gif" width="20" height="20" />批量新建</sky:button></td>
		</tr>
	</table>
	<form id="form2">
