...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.xdarkness.cms.site.NewspaperIssue.getPicSrc",dc,function(response){
		$("Pic").src = response.gsky:("picSrc");
	})
}
...
<z:init method="com.xdarkness.cms.site.Newspaper.initDialog">
	...
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td align="left"><input name="Alias" type="text" class="input1"
				id="Alias" value="${Alias}" size=sky:0" verify="英文名|NotNull" /></td>
		</tr>
		<tr>
		sky:td align="right">出版间隔：</td>
			<td align="left">
		...
		<tr>
			...
			<td align="left"><span class="tdgrey2"> <input
				...
				for="UseFlag0">停用</label> <input type="rasky:o" name="UseFlag"
