...
function getDocList(){
	...
	<body>
	<form id="form2"><sky:datagrid id="dg1"
		method="com.xdarkness.cms.site.PageBlock.blockItemDataBind" size="15"
		page="false">
		<table width=95% cellpadding="2" cellspacing="0" id="tableItems"
			class="dataTable">
			<tr xtype="head" class="dataTableHead">
				<td width="6%" height="30" xtype="RowNo" drag="true"><img
					src="../Framework/Images/icon_drag.gif" width="16" height="16"></td>
				<td width="10%"></td>
				<td width="40%"><strong>标题:</strong></td>
				<td width="34%"><strong>地址:</strong></td>
				<td width="10%" xtype="edit"><strong>编辑</strong></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
