...
<table width="100%" border="0" cellspacing="6" cellpadding="0"
	...
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td valign="middle" class="blockTd">媒体库类型：<sky:select
			...
			<tr>
				<td style="padding:0 6px;"><sky:tree id="tree1"
					style="height:425px;width:160px;"
					method="com.xdarkness.cms.site.Catalog.treeResourceDataBind" level="2"
					lazy="true">
