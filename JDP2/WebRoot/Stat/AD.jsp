	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<sky:select id="PositionID" style="width:200px" listWidth="300" listHeight="350" defaultblank="true" method="com.xdarkness.cms.stat.report.TopReport.getADPositionList">
				
				</sky:select> <input type="button" verify="Date" name="Submitbutton"
			...
			<tr>
				...
				<sky:datagrid id="dg1"
					method="com.xdarkness.cms.stat.report.TopReport.dgADDataBind"
