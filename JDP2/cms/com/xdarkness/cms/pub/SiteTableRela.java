...
public class SiteTableRela {
	public static TableRela[] getRelas() {
		...
		list.add(new TableRela("ZCAdvertisement", "PositionID", "ZCAdPosition",
				"ID", null, false));
		list.add(new TableRela("ZCAdVisitLog", "AdID", "ZCAdvertisement", "ID",
				null));
		list.add(new TableRela("ZCApproval", "ArticleID", "ZCArticle", "ID",
				null, false));
		list.add(new TableRela("ZCArticleLog", "ArticleID", "ZCArticle", "ID",
				null));
		list.add(new TableRela("ZCArticlePage", "ArticleID", "ZCArticle", "ID",
				null));
		list.add(new TableRela("ZCArticle", "CatalogID", "ZCCatalog", "ID",
				null, false));

		list.add(new TableRela("ZCAttachmentRela", "RelaID", "ZCArticle", "ID",
				null));
		list
				.add(new TableRela("ZCAudioRela", "RelaID", "ZCArticle", "ID",
						null));
		list.add(new TableRela("ZCImageRela", "RelaID", "ZCArticle", "ID",
				"RelaType='ArticleImage'"));
		list.add(new TableRela("ZCImageRela", "RelaID", "ZCImagePlayer", "ID",
				"RelaType='ImagePlayerImage'"));
		list
				.add(new TableRela("ZCVideoRela", "RelaID", "ZCArticle", "ID",
						null));

		list.add(new TableRela("ZCAttachmentRela", "ID", "ZCAttachment", "ID",
				null, false));
		list.add(new TableRela("ZCAudioRela", "ID", "ZCAudio", "ID", null,
				false));
		list.add(new TableRela("ZCImageRela", "ID", "ZCImage", "ID", null,
				false));
		list.add(new TableRela("ZCVideoRela", "ID", "ZCVideo", "ID", null,
				false));

		list.add(new TableRela("ZCAttachment", "CatalogID", "ZCCatalog", "ID",
				null, false));
		list.add(new TableRela("ZCAudio", "CatalogID", "ZCCatalog", "ID", null,
				false));
		list.add(new TableRela("ZCCatalog", "ParentID", "ZCCatalog", "ID",
				null, false));
		list.add(new TableRela("ZCVideo", "CatalogID", "ZCCatalog", "ID", null,
				false));
		list.add(new TableRela("ZCImage", "CatalogID", "ZCCatalog", "ID", null,
				false));

		list.add(new TableRela("ZCComment", "RelaID", "ZCArticle", "ID", null,
				false));
		list.add(new TableRela("ZCComment", "CatalogID", "ZCCatalog", "ID",
				null, false));
		list.add(new TableRela("ZCDeployJob", "ConfigID", "ZCDeployConfig",
				"ID", null, false));
		list.add(new TableRela("ZCDeployLog", "JobID", "ZCDeployJob", "ID",
				null, false));

		list.add(new TableRela("ZCLink", "LinkGroupID", "ZCLinkGroup", "ID",
				null, false));
		list.add(new TableRela("ZCMagazineIssue", "MagazineID", "ZCMagazine",
				"ID", null));
		list.add(new TableRela("ZCMagazineCatalogRela", "CatalogID",
				"ZCCatalog", "ID", null));
		list.add(new TableRela("ZCMagazineCatalogRela", "MagazineID",
				"ZCMagazine", "ID", null, false));
		list.add(new TableRela("ZCMagazineCatalogRela", "IssueID",
				"ZCMagazineIssue", "ID", null, false));

		list.add(new TableRela("ZCPageBlock", "CatalogID", "ZCCatalog", "ID",
				null, false));
		list.add(new TableRela("ZCPageBlockItem", "BlockID", "ZCPageBlock",
				"ID", null));
		list.add(new TableRela("ZCTemplateBlockRela", "BlockID", "ZCPageBlock",
				"ID", null, false));

		list
				.add(new TableRela("ZCVoteSubject", "VoteID", "ZCVote", "ID",
						null));
		list.add(new TableRela("ZCVoteItem", "VoteID", "ZCVote", "ID", null));
		list.add(new TableRela("ZCVoteItem", "SubjectID", "ZCVoteSubject",
				"ID", null, false));
		list.add(new TableRela("ZCVoteLog", "VoteID", "ZCVote", "ID", null));

		list.add(new TableRela("ZDColumnRela", "RelaID", "ZCCatalog", "ID",
				"RelaType='0'"));
		list.add(new TableRela("ZDColumnRela", "RelaID", "ZCCatalog", "ID",
				"RelaType='1'"));
		list.add(new TableRela("ZDColumnRela", "ColumnID", "ZDColumn", "ID",
				null, false));
		list.add(new TableRela("ZDColumnValue", "RelaID", "ZCCatalog", "ID",
				"RelaType='0'"));
		list.add(new TableRela("ZDColumnValue", "RelaID", "ZCArticle", "ID",
				"RelaType='2'"));
		list.add(new TableRela("ZDColumnValue", "ColumnID", "ZDColumn", "ID",
				null, false));

		list.add(new TableRela("ZDSchedule", "SourceID", "ZCFullText", "ID",
				"TypeCode='IndexMaintenance'"));

		list.add(new TableRela("ZDSchedule", "SourceID", "ZCWebGather", "ID",
				"TypeCode='WebCrawl'"));
		list.add(new TableRela("ZCCustomTable", "DatabaseID", "ZCDatabase",
				"ID", null, false));
		list.add(new TableRela("ZCCustomTableColumn", "TableID",
				"ZCCustomTable", "ID", null));

		list.add(new TableRela("ZCArticle", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZCImage", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZCVideo", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZCAttachment", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZCAudio", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZCArticle", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));

		list.add(new TableRela("ZCCatalogConfig", "CatalogID", "ZCCatalog",
				"ID", null, false));
		list.add(new TableRela("ZCCatalogConfig", "CatalogInnerCode",
				"ZCCatalog", "InnerCode", null, false));
		list.add(new TableRela("ZCCatalog", "Parent", "ZCCatalog", "ID", null,
				false));

		list.add(new TableRela("ZSGoods", "CatalogID", "ZCCatalog", "ID", null,
				false));
		list.add(new TableRela("ZSGoods", "CatalogInnerCode", "ZCCatalog",
				"InnerCode", null, false));
		list.add(new TableRela("ZSBrand", "BranchInnerCode", "ZDBranch",
				"BranchInnerCode", null, false));
		list.add(new TableRela("ZSPaymentProp", "PaymentID", "ZSPayment", "ID",
				null));

		list.add(new TableRela("ZCForumScore", "ID", "ZCForumGroup", "ID",
				null, false));
		list.add(new TableRela("ZCForumAttachment", "PostID", "ZCPost", "ID",
				null, false));
		list.add(new TableRela("ZCForumMember", "AdminID", "ZCForumGroup",
				"ID", null, false));
		list.add(new TableRela("ZCForumMember", "UserGroupID", "ZCForumGroup",
				"ID", null, false));
		list.add(new TableRela("ZCForumMember", "DefinedID", "ZCForumGroup",
				"ID", null, false));
	...
	public static NoType[] getNoRelaArray() {
		...
		list
				.add(new NoType("ZCCustomTableColumn", "ID",
						"CustomTableColumnID"));
	...
	public static String[] getSiteIDTablesBySchema() {
		ArrayList list = new ArrayList();
		String path = ZDCodeSchema.class.getResource("ZDCodeSchema.class")
				.getPath();
			...
			try {
				...
				while (all.hasMoreElements()) {
					...
					if (name.startsWith("com.xdarkness.schema.")) {
						name = name.substring("com.xdarkness.schema.".length(),
								name.lastIndexOf(".") + 1);
	...
	public static boolean hasSiteIDField(String tableName) {
		...
		try {
			Schema schema = (Schema) Class.forName(
					"com.xdarkness.schema." + tableName + "Schema").newInstance();
	...
	public static QueryBuilder getSelectQuery(long SiteID, TableRela tr) {
		...
		sf.add(tr.TableCode);
		if (XString.isNotEmpty(tr.Condition))
			sf.add(tr.Condition);
		else {
			sf.add("1=1");
		}
	...
	public static void clearData() {
		...
		for (int i = 0; i < tables.length; i++) {
			QueryBuilder qb = new QueryBuilder("delete from " + tables[i]
					+ " where not exists (select 1 from ZCSite where ID="
					+ tables[i] + ".SiteID)");
			tran.add(qb);
		}
		TableRela[] trs = getRelas();
		for (int i = 0; i < trs.length; i++) {
			...
			if (tr.isExportData) {
				StringFormat sf = new StringFormat(
						"delete from ? where ? and not exists (select 1 from ? where ?=?.?)");
				sf.add(tr.TableCode);
				if (XString.isNotEmpty(tr.Condition))
					sf.add(tr.Condition);
				else {
	...
	public static class TableRela implements Serializable {
		...
		public TableRela(String TableCode, String KeyField, String RelaTable,
				String RelaField, String Condition, boolean isExportData) {
			this.TableCode = TableCode;
		...
		public TableRela(String TableCode, String KeyField, String RelaTable,
				String RelaField, String Condition) {
...
/*
 * com.xdarkness.cms.pub.SiteTableRela JD-Core Version: 0.6.0
 */