...
public class StatUtil {
	...
	public static long convertIP(String ip) {
		String[] arr1 = XString.splitEx(ip, ".");
		try {
			long t = Long.parseLong(arr1[0]) * 16777216L
					+ Long.parseLong(arr1[1]) * 65536L
					+ Long.parseLong(arr1[2]) * 256L + Long.parseLong(arr1[3])
					- 1L;
			return t;
		} catch (Exception e) {
			LogUtil.warn("错误的IP地址:" + ip);
		}
		return 0L;
	}
	...
	public static String getIP(HttpServletRequest request) {
		...
		if ((XString.isEmpty(ip)) || ("unknown".equalsIgnoreCase(ip))) {
...
/*
 * com.xdarkness.cms.stat.StatUtil JD-Core Version: 0.6.0
 */