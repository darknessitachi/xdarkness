...
public class IndexUtil {
	...
	public static String getTextFromHtml(String html) {
		...
		if (XString.isEmpty(text)) {
			text = XString.clearHtmlTag(html);
		}
	...
	public static boolean filter(String word) {
		if ((filterWords == null) || (filterChars == null)) {
			try {
				filterWords = FileUtil.readText(IndexUtil.class.getResource(
						"wordfilter.dic").openStream(), "UTF-8");
				filterChars = FileUtil.readText(IndexUtil.class.getResource(
						"charfilter.dic").openStream(), "UTF-8");
	...
	public static String getTextAbstract(String title, String content) {
		try {
			...
			TokenStream tokenStream = new IKAnalyzer().tokenStream("CONTENT",
...
/*
 * com.xdarkness.search.index.IndexUtil JD-Core Version: 0.6.0
 */