...
public class RolePriv {
	...
	public static void updateAllPriv(String RoleCode) {
		Object obj = new QueryBuilder(
				"select RoleCode from ZDRole where RoleCode = ?", RoleCode)
				.executeOneValue();
		if (obj == null) {
	...
	public static boolean getRolePriv(String[] RoleCodes, String PrivType,
...
/*
 * com.xdarkness.platform.RolePriv JD-Core Version: 0.6.0
 */