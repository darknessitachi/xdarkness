...
<script>
	...
	function save(){
		...
		Server.sendRequest("com.xdarkness.cms.site.FileList.edit",dc,function(response){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><sky:button onClick="save()">
			<img src="../../Icons/icon018a2.gif" />保存</sky:button> <sky:button
			onClick="closeX()">
			<img src="../../Icons/icon403a11.gif" />关闭</sky:button></td>
	</tr>
</table>
<div id="FlashDiv"></div>
