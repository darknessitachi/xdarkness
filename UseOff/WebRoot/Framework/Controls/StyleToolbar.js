...
StyleToolbar.prototype.addFontFamily = function(){
	this.Html.push("<td><div title='字体' xtype='Select' style='width:80px;display:none' id='"+this.ID+"_FontFamily' onchange=\"StyleToolbar.onChange('"+this.ID+"')\">");
...
StyleToolbar.prototype.addFontSize = function(){
	this.Html.push("<td><div title='字号' xtype='Select' style='width:60px;display:none' id='"+this.ID+"_FontSize' onchange=\"StyleToolbar.onChange('"+this.ID+"')\">");
