...
function addSave(){
	...
	Server.sendRequest("com.xdarkness.platform.District.add",dc,function(response){
...
function save(){
	DataGrid.save("dg1","com.xdarkness.platform.District.dg1Edit",function(){
		DataGrid.loadData('dg1');
	});
}
...
function del(){
	...
	dc.add("IDs",arr.join());
	Server.sendRequest("com.xdarkness.platform.District.del",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				DataGrid.loadData("dg1");
			}
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="8" class="blockTable">
				...
				<tr>
					...
					<sky:button id="addButton" onClick="save()">
						<img src="../Icons/icon018a4.gif"/>保存</sky:button>
					<sky:button onClick="del()">
						<img src="../Icons/icon018a3.gif"/>删除</sky:button></td>
				</tr>
				<tr>
					<td style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
					<sky:datagrid id="dg1" method="com.xdarkness.platform.District.dg1BindDistrict">
						<table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
							<tr xtype="head" class="dataTableHead">
								<td  width="5%" xtype="RowNo"><b>序号</b></td>
								<td width="5%" xtype="selector" field="Code">&nbsp;</td>
								<td width="20%" xtype="tree" level="TreeLevel"><b>省市</b></td>
