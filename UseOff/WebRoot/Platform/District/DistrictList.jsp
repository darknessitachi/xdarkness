...
function save(){
	DataGrid.save("dg2","com.xdarkness.platform.District.dg1Edit",function(){
...
<body>
<sky:init method="com.xdarkness.platform.District.init">
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="8" class="blockTable">
				...
				<tr>
					...
					<sky:datagrid id="dg2" method="com.xdarkness.platform.District.dg1BindDistrictList" page="false">
