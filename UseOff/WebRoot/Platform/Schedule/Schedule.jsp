...
function save(){
	...
	Server.sendRequest("com.xdarkness.platform.page.SchedulePage.save",dc,function(response){
...
function execute(){
	...
	dc.add("ID",dr.get("ID"));
	Server.sendRequest("com.xdarkness.platform.page.SchedulePage.execute",dc,function(response){
		Dialog.alert(response.Message);
	});
}
...
function del(){
	...
	Dialog.confirm("确定要删除该配置项吗？",function(){
		var dc = new DataCollection();	
		dc.add("IDs",arr.join());
		Server.sendRequest("com.xdarkness.platform.page.SchedulePage.del",dc,function(response){
...
<sky:init method="com.xdarkness.platform.page.SchedulePage.init">
	<body>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            <tr>
              <td valign="middle" class="blockTd"><img src="../../Icons/icon020a1.gif" width="20" height="20" /> 定时计划列表</td>
				...
				<tr>
					<td style="padding:0 8px 4px;"><sky:button onClick="add()"><img src="../../Icons/icon020a2.gif" width="20" height="20" />新建</sky:button>
                  <sky:button onClick="edit()"> <img src="../../Icons/icon020a4.gif" width="20" height="20" />修改</sky:button>
                  <sky:button onClick="del()"> <img src="../../Icons/icon020a3.gif" width="20" height="20" />删除</sky:button>
                  <sky:button onClick="execute()"> <img src="../../Icons/icon020a9.gif" width="20" height="20" />手动执行</sky:button>
			 </td>
            </tr>
            <tr>
              <td style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
			  <sky:datagrid id="dg1" method="com.xdarkness.platform.page.SchedulePage.dg1DataBind" size="15">
