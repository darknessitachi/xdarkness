...
function save(){
	...
	Server.sendRequest("com.xdarkness.platform.UserTabSite.dg1Edit",dc,function(response){
...
<sky:datagrid id="dg1" method="com.xdarkness.platform.UserTabSite.dg1DataBind" size="10">
