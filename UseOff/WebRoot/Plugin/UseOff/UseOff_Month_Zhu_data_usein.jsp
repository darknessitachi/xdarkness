...
DataTable dataTable = new QueryBuilder("select sum(money) as money, substring(createTime,3,5) as theMonth from useoff where moneyType='in' and usefor != 'home' group  by theMonth").executeDataTable();
